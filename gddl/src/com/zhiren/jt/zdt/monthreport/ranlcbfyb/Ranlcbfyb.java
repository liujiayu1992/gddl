...
//		 工具栏的年份和月份下拉框
	...
	egu.getColumn("gongrmtcb").setHeader("供热煤炭成本");
	egu.getColumn("fadycb").setHeader("发电油成本");
	egu.getColumn("gongrycb").setHeader("供热油成本");
...
//	设置不可编辑的颜色
	...
	//********************工具栏************************************************
		...
		egu.addTbarText("->");
		egu.addTbarText("<font color=\"#EE0000\">单位:万元</font>");
