...
public class LAIYQKB extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select ly.id,ly.meikxxb_id,ly.ranlpzb_id,ly.shourl,ly.leij,ly.tiaozl,ly.lury\n" +
			"from LAIYQKB ly";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("meikxxb_id").setHeader("发货单位");
		egu.getColumn("meikxxb_id").setWidth(80);
		egu.getColumn("ranlpzb_id").setHeader("品种");
		egu.getColumn("ranlpzb_id").setWidth(120);
		egu.getColumn("shourl").setHeader("当日");
		egu.getColumn("shourl").setWidth(120);
		egu.getColumn("leij").setHeader("月累计");
		egu.getColumn("leij").setWidth(120);
		egu.getColumn("tiaozl").setHeader("结算后调整量");
		egu.getColumn("tiaozl").setWidth(120);
		egu.getColumn("lury").setHeader("收油情况");
		egu.getColumn("lury").setWidth(120);
