...
public class Ruchyejsh_duotsh extends BasePage implements PageValidateListener {
	private String CustomSetKey = "Ruchyejsh_duotsh";
	private String msg = "";
...
//			riq2change = true;
	...
	public void Save(){
		...
		while (mdrsl.next()) {
			...
			+"values("+mdrsl.getString("id")+",'"+mdrsl.getString("huaybianh")+"',"+mdrsl.getString("caiyb_id")+","
...
//			更改时增加日志
	...
	public void getSelectData(){
		...
		if ("是".equals(mark)) {
			...
			if("是".equals(erjshxs) && "进厂批号".equals(zzhy)){
				sql = "select a.id,a.meikdw,a.faz,a.caiyb_id,a.pinz,a.ches,a.shul,a.huaybh," +
						"zm.bianm huaybianh,a.huaysj," +
						"to_char(a.qnet_ar,'90.99') qnet_ar,"+
						"round_new(a.qnet_ar/0.0041816,0) qnet_ar1," +
						"to_char(a.aar,'90.99') aar,"+
						"to_char(a.ad,'90.99') ad,"+
						"to_char(a.vdaf,'90.99') vdaf,"+
						"to_char(a.mt,'90.9') mt,"+
						"to_char(a.stad,'90.99') stad,"+
						"to_char(a.aad,'90.99') aad,"+
						"to_char(a.mad,'90.99') mad,"+
						"to_char(round_new(a.qbad,2),'90.99') qbad,"+
						"to_char(a.had,'90.99') had,"+
						"to_char(a.vad,'90.99') vad,"+
						"to_char(a.fcad,'90.99') fcad,"+
						"to_char(a.std,'90.99') std,"+
						"to_char(round_new(a.qgrad,2),'90.99') qgrad,"+
						"to_char(a.hdaf,'90.99') hdaf,"+
						"to_char(round_new(a.qgrad_daf,2),'90.99') qgrad_daf,"+
						"to_char(a.sdaf,'90.99') sdaf,"+
						"a.t1,a.t2,a.t3,a.t4,a.huayy,a.lury,a.beiz  " +
                        ...
                        "and a.id in (select zhilb_id from fahb where to_char(daohrq,'yyyy-mm-dd') between '"+this.getBeginRiq()+"' and '"+this.getEndRiq()+"')\n" +
                        "order by a.huaysj"
                       ;
			}else{
		...
		if("是".equals(erjshxs) && "进厂批号".equals(zzhy)){
			...
			egu.getColumn("huaybianh").setWidth(130);
		}
