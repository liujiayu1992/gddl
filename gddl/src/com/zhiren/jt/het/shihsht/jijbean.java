...
public class jijbean implements Serializable{
	...
	public jijbean(int xuh,long id, String zhibb_id, String tiaojb_id, double shangx, double xiax, String danwb_id, double jij, String jijdwid,  double yunj, String yunjdw_id, String yingdkf,  double zuigmj) {
		super();
		this.id = id;
		this.zhibb_id = zhibb_id;
		this.tiaojb_id = tiaojb_id;
