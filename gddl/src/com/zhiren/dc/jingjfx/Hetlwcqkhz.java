...
public class Hetlwcqkhz extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	strSql=
	"insert into hetlwcqkhzb(id,riq,zdhtl,zddhl,qyhtl,qydhl,schtl,scdhl,diancxxb_id)(\n" + 
	"select "+MainGlobal.getNewID(visit.getDiancxxb_id())+",sysdate,1000,20000,20000,333,555,66660,"+visit.getDiancxxb_id()+" from dual\n" + 
	"\n" + 
	")";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id,riq,zdhtl,zddhl,qyhtl,qydhl,schtl,scdhl\n" +
			"from hetlwcqkhzb\n" + 
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("zdhtl").setHeader("重点订货合同量(吨)");
		egu.getColumn("zdhtl").setWidth(150);
		egu.getColumn("zddhl").setHeader("重点订货到货量(吨)");
		egu.getColumn("zddhl").setWidth(150);
		egu.getColumn("qyhtl").setHeader("区域订货合同量(吨)");
		egu.getColumn("qyhtl").setWidth(150);
		egu.getColumn("qydhl").setHeader("区域订货到货量(吨)");
		egu.getColumn("qydhl").setWidth(150);
		egu.getColumn("schtl").setHeader("市场订货合同量(吨)");
		egu.getColumn("schtl").setWidth(150);
		egu.getColumn("scdhl").setHeader("市场订货到货量(吨)");
		egu.getColumn("scdhl").setWidth(150);
