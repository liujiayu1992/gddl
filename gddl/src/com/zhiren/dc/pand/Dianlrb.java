...
//	界面用户提示
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select to_char(riq,'YYYY-MM-DD') riq,bum,reny,gongznr\n" +
			"from pandbp";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("bum").setWidth(120);
		egu.getColumn("reny").setHeader("人员");
		egu.getColumn("reny").setWidth(120);
		egu.getColumn("gongznr").setHeader("工作内容");
		egu.getColumn("gongznr").setWidth(120);
