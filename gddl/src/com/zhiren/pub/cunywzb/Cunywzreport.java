...
public class Cunywzreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append(" select mingc,decode(zhuangt,0,'是','否') as zhuangt from cunywzb \n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"名称","是否启用"};

		
		//列宽
		 int ArrWidth[]=new int[] {200,60};



		//设置页标题
		rt.setTitle("存样位置信息表",ArrWidth);
...
//		rt.body.mergeFixedCol(1);
		...
		rt.setDefautlFooter(1,2,"打印日期:"+DateUtil.FormatDate(new Date()),Table.ALIGN_RIGHT);
