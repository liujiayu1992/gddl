...
public class Yuexsmxqtb extends BasePage implements PageValidateListener {
...
//			System.out.println(chaxun);
		...
		egu.getColumn("pinz_id").setHeader("品种");
		egu.getColumn("hetl").setHeader("合同量");
		egu.getColumn("xuql").setHeader("需求量");
		egu.getColumn("hedl").setHeader("核定量");
		...
		egu.getColumn("pinz_id").setWidth(80);
		...
		egu.getColumn("hedl").setWidth(100);
		egu.getColumn("hedl").setDefaultValue("0");
...
//		egu.getColumn("diancxxb_id").setDefaultValue(getDiancmc());
		...
		egu.getColumn("pinz_id").setEditor(c5);
		c5.setEditable(true);
