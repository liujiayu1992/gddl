...
public class Quzpkqkb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select q.quz6,q.zhanc6,q.paik6,q.daix6,q.quz18,q.zhanc18,q.paik18,q.daix18,q.hej18\n" +
			"from quzpkqkb q";
			JDBCcon con = new JDBCcon();
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("quz6").setHeader("到达车辆(6点)");
		egu.getColumn("quz6").setWidth(80);
		egu.getColumn("zhanc6").setHeader("入厂车辆(6点)");
		egu.getColumn("zhanc6").setWidth(120);
		egu.getColumn("paik6").setHeader("排空车辆(6点)");
		egu.getColumn("paik6").setWidth(120);
		egu.getColumn("daix6").setHeader("厂内待卸(6点)");
		egu.getColumn("daix6").setWidth(120);
		egu.getColumn("quz18").setHeader("入厂车辆(18点)");
		egu.getColumn("quz18").setWidth(120);
		
		egu.getColumn("zhanc18").setHeader("车数(18点)");
		egu.getColumn("zhanc18").setWidth(120);
		egu.getColumn("paik18").setHeader("排空车辆(18点)");
		egu.getColumn("paik18").setWidth(120);
		egu.getColumn("daix18").setHeader("厂内待卸(18点)");
		egu.getColumn("daix18").setWidth(120);
		egu.getColumn("hej18").setHeader("厂停时间(18点)");
		egu.getColumn("hej18").setWidth(120);
