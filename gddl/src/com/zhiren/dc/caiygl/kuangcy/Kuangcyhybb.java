 ...
 */
public class Kuangcyhybb extends BasePage {
...
//			1120
			ArrHeader[0]=new String[] {"采样日期","煤矿名称","编号","全水<br>Mt(%)","内水<br>Mad(%)","空干灰<br>Aad(%)",
					"干灰<br>Ad(%)","空干挥发份<br>Vad(%)","干燥无灰基挥发份<br>Vdaf(%)",
					"空气干燥基全硫<br>St,ad(%)","干燥基全硫<br>St,d(%)","空气干燥基氢<br>Had(%)","弹筒热<br>Qb.ad(%)",
					"高位热<br>Qgr,d(%)","低位热<br>Qnet,ar(%)","低位发热量<br>(大卡)","采样人","采样<br>批准人","化验员"};
			...
			// 数据
			  if(visit.getDiancmc().equals("宣威发电")){
				  rt.setTitle("煤质化验中心监控样报表",ArrWidth);
			  }else{
				  rt.setTitle("煤质化验中心矿采样报表",ArrWidth);
			  }
