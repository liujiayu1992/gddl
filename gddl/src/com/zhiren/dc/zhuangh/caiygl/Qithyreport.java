 ...
 */
public class Qithyreport extends BasePage {
//	 判断是否是集团用户
...
//		String zhuangt=this.getBaoblxValue().getStrId();
		...
		String c_sql=
			...
			"select zm.bianm,q.meizbh,round_new(z.mt,1),z.mad,z.aad,\n" +
			"z.vad,z.stad,z.had,z.fcad,z.aar,z.vdaf, z.ad,round_new((z.vad/(100-z.mad))*100,2) as vd ," +
			"round_new(z.qbad,2),round_new(z.qgrd,2),round_new(z.qgrad,2)," +
			"round_new(z.qnet_ar,2), round_new(round_new(z.qnet_ar,2) * 1000 / 4.1816, 0),z.huayy,to_char(z.huaysj,'yyyy-mm-dd')" +
			" from qitymxb q ,zhillsb z ,zhuanmb zm,zhuanmlb l\n" + 
			" where q.id=z.id\n" + 
			"      and z.id=zm.zhillsb_id and zm.zhuanmlb_id=l.id and l.jib=3\n" + 
			"      and to_char(z.huaysj,'yyyy-mm-dd') ='"+getRiq()+"'"

			;
		String c_sq=
			"select zm.bianm,round_new(z.mt,1),z.mad,z.aad,\n" +
			"z.vad,z.stad,z.had,z.fcad,z.aar,z.vdaf, z.ad,round_new((z.vad/(100-z.mad))*100,2) as vd ," +
			"round_new(z.qbad,2),round_new(z.qgrd,2),round_new(z.qgrad,2)," +
			"round_new(z.qnet_ar,2), round_new(round_new(z.qnet_ar,2) * 1000 / 4.1816, 0),z.huayy,to_char(z.huaysj,'yyyy-mm-dd') " +
			",z.shenhry,z.shenhryej from qitymxb q ,zhillsb z ,zhuanmb zm,zhuanmlb l\n" + 
			" where q.id=z.id\n" + 
			"      and z.id=zm.zhillsb_id and zm.zhuanmlb_id=l.id and l.jib=3\n" + 
			"      and to_char(z.huaysj,'yyyy-mm-dd') ='"+getRiq()+"'"
		...
		if(!"".equals(gethetbh())){
			c_sql=
				...
				" where q.id=z.id\n" + 
				"      and z.id=zm.zhillsb_id and zm.zhuanmlb_id=l.id and l.jib=3\n" + 
				"      and zm.bianm='"+gethetbh().toUpperCase()+"'"
...
//			footer.append("</tr></table>");
		...
		rt.setTitle("其他样煤化验报告单",ArrWidth);
		//footer
