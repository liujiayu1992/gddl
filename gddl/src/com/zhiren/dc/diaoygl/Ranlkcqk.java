...
public class Ranlkcqk extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select k.id,k.zuorkc,k.benrkc,k.kuczjl,k.keyts\n" +
			"from Ranlkcqk k";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("benrkc").setHeader("本日库存");
		egu.getColumn("benrkc").setWidth(120);
		egu.getColumn("kuczjl").setHeader("库存增减量");
		egu.getColumn("kuczjl").setWidth(120);
		egu.getColumn("keyts").setHeader("可用天数");
		egu.getColumn("keyts").setWidth(120);
