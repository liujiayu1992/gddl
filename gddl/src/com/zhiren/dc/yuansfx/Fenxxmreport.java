...
public class Fenxxmreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select xuh,mingc from fenxxmb\n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","分析项目名称"};

		
		//列宽
		 int ArrWidth[]=new int[] {60,160};



		//设置页标题
		rt.setTitle("分析项目信息表",ArrWidth);
