...
public class Cheltycx extends BasePage {
...
//	刷新衡单列表
	public void getSelectData() {
		...
		/*tb1.addText(new ToolbarText("停用日期:"));
	...
	public String getYansd(){
		...
		if(cheh==-1){
			...
			sbsql.append(
					...
					" select rownum as xuh,c.cheph,c.suocr,\n" +
					" to_char(c.suocsj,'yyyy-mm-dd hh24:mi:ss') as suocsj,\n" + 
					" c.jiecr,to_char(c.jiecsj,'yyyy-mm-dd hh24:mi:ss') as jiecr\n" + 
					" from chelxxlogb c" +
					" where 1=1 " +
					" "+tiaoj+" " +
					" "+chehtj+"  "+
...
//				1120
				ArrHeader[0]=new String[] {"序号","车号","锁车人","锁车时间","解锁人","解锁时间"};
				int ArrWidth[]=new int[] {50,80,90,200,80,200};
				  strFormat = new String[] { "", "","","","","" };
				// 数据
				rt.setTitle(visit.getDiancmc()+"车辆停用查询",ArrWidth);
...
//	 车号下拉框
	...
	public void getChehModels() {
		...
		String sql_gongys =
			...
			" select distinct c.cheph from chelxxlogb c) order by cheph ";
...
//	 停用人下拉框
	...
	public void getCaiyhModels() {
		...
		String sql_gongys =
			...
			"select distinct c.suocr from chelxxlogb c) order by suocr";
