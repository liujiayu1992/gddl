...
/*作者:王总兵
 *日期:2010-5-19 14:13:00
 *描述:增加飞灰含碳量二级审核
 * 
 */
public class Feihlzjccx_es extends BasePage {
//	客户端的消息框
	private String msg = "";
...
//	页面初始化(每次刷新都执行)
	...
	public void Shenh(){
		...
		int flag=0;
		String Fenyzt=
			"update feihlzb f set f.shenhzt=2,f.shenhyej='"+visit.getRenymc()+"',f.shenhsjej=sysdate\n" +
	...
	private String getSelectData() {
		...
		sql = "select to_char(quysj,'yyyy-mm-dd') as quysj, f.beiz,f.lury,f.shenhyyj  from feihlzb f,jizxxb j where f.diancxxb_id = " + getTreeid() 
	...
	private void getToolbars() {
		...
		tb1.addText(new ToolbarText("-"));
		tb1.addText(new ToolbarText("-"));
		ToolbarButton rbtn = new ToolbarButton(null,"二级审核","function(){document.getElementById('ShenhButton').click();}");
...
//	}
	...
	public void getIRiqModels() {		
		...
		String sql = 
			...
			" from feihlzb f where f.shenhzt=1\n" + 
			"order by fenxsj)";
		ResultSetList rsl = con.getResultSetList(sql);
		if(rsl.getRows()>0){
