...
public class Meicreport extends BasePage {
	...
	private String getRezc() {
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","名称","拼音","最大库存(t)","长度(m)","宽度(m)","面积(m<sup>2</sup>)","堆高(m)","面积(m<sup>3</sup>)","垫底煤量(t)","备注"};
		// 列宽
		 int ArrWidth[]=new int[] {50,60,70,90,60,60,60,60,60,90,90};
