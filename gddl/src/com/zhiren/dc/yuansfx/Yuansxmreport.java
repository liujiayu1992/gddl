...
public class Yuansxmreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select xuh,mingc,decode(zhuangt,0,'启用','未启用')as zhuangt from yuansxmb order by xuh,mingc \n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","名称","启用状态"};

		
		//列宽
		 int ArrWidth[]=new int[] {60,160,100};



		//设置页标题
		rt.setTitle("元素项目信息表",ArrWidth);
