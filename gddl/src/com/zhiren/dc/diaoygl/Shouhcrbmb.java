...
public class Shouhcrbmb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select sm.id,sm.shisl,sm.yuns,''jingz,sm.fady,sm.gongry,sm.qity,sm.chus,sm.diaoc,sm.shuifctz,sm.tiaoz,sm.kuc\n" +
			"from shouhcrbmb sm";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("shisl").setHeader("入厂量");
		egu.getColumn("shisl").setWidth(80);
		egu.getColumn("yuns").setHeader("运损");
		egu.getColumn("yuns").setWidth(120);
		egu.getColumn("jingz").setHeader("净重");
		egu.getColumn("jingz").setWidth(120);
		egu.getColumn("fady").setHeader("发电用");
		egu.getColumn("fady").setWidth(120);
		egu.getColumn("gongry").setHeader("供热用");
		egu.getColumn("gongry").setWidth(120);
		egu.getColumn("qity").setHeader("其它用");
		egu.getColumn("qity").setWidth(120);
		egu.getColumn("chus").setHeader("储损");
		egu.getColumn("chus").setWidth(120);
		egu.getColumn("diaoc").setHeader("调出");
		egu.getColumn("diaoc").setWidth(120);
		
		egu.getColumn("shuifctz").setHeader("水分差调整");
		egu.getColumn("shuifctz").setWidth(120);
		egu.getColumn("tiaoz").setHeader("调整");
		egu.getColumn("tiaoz").setWidth(120);
		egu.getColumn("kuc").setHeader("库存");
		egu.getColumn("kuc").setWidth(120);
