...
public class Caizhdyreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select b.mingc as bum_id,c.zer,l.mingc as leibb_id from caizhdyb c,bumb b,leibb l where c.bum_id=b.id and c.leibb_id=l.id order by c.id\n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"部门","责任（化验、采样、制样）","类别"};

		
		//列宽
		 int ArrWidth[]=new int[] {120,120,80};



		//设置页标题
		rt.setTitle("采制化对应设置信息表",ArrWidth);
...
//		rt.body.mergeFixedCol(1);
		...
		rt.setDefautlFooter(1,3,"打印日期:"+DateUtil.FormatDate(new Date()),Table.ALIGN_RIGHT);
