 ...
 */
public class PublicAutoRunListener  implements ServletContextListener{
...
//			System.out.print("Curtime:"+curtime + "     time:" + time);
			if(Math.abs(curtime - time) <= _range) {
				AutoCreateShouhcrb.Create(con, _diancxxb_id, DateUtil.AddDate(curDate, -1, DateUtil.AddType_intDay), true);
