package com.zhiren.jt.huanbjgpxbreport;
...
public class Huanbjgpxbreport  extends BasePage implements PageValidateListener{
...
//		String riq=FormatDate(_BeginriqValue);
		...
		if(jib==1){//选择集团的时候按照分公司统计,其它的按照到达类型统计
			strSQL=
				...
				"            and dr04.riq=to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd') and dr08.fenx='本月' and dr04.fenx='本月'\n" + 
				"            and dc.fuid=dq.id  "+strGongsID+"\n" + 
				"      group by (dq.id)\n" + 
				"      )bq\n" + 
				"      ,\n" + 
				...
				"             decode(sum(dr08.meil),0,0,round(sum(dr08.meil*dr08.biaomdj)/sum(dr08.meil),2)) as biaomdjhs\n" + 
				"      from diaor04bb dr04,diaor08bb dr08,diancxxb dc,diancxxb dq\n" + 
				"      where dr04.diancxxb_id=dc.id and dr08.diancxxb_id=dc.id and dr08.riq=add_months(to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd'),-1)\n" + 
				"            and dr04.riq=add_months(to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd'),-1) and dr08.fenx='本月' and dr04.fenx='本月'\n" + 
				"            and dc.fuid=dq.id  "+strGongsID+"\n" + 
				"      group by (dq.id)\n" + 
				"      )tq\n" + 
...
//		String riq=FormatDate(_BeginriqValue);
		...
		if(jib==1){//选择集团的时候按照分公司统计,其它的按照到达类型统计
			strSQL=
				...
				"           where dr04.diancxxb_id=dc.id and dr08.diancxxb_id=dc.id and dr08.riq=to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd')\n" + 
				"                 and dr04.riq=to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd') and dr08.fenx='本月' and dr04.fenx='本月'  "+strGongsID+"\n" + 
				"           group by (dc.id)\n" + 
				"           )bq\n" + 
				"           ,\n" + 
				"           (\n" + 
				...
				"           from diaor04bb dr04,diaor08bb dr08,diancxxb dc\n" + 
				"           where dr04.diancxxb_id=dc.id and dr08.diancxxb_id=dc.id and dr08.riq=add_months(to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd'),-1)\n" + 
				"                 and dr04.riq=add_months(to_date('"+intyear+"-"+intMonth+"-01','yyyy-mm-dd'),-1) and dr08.fenx='本月' and dr04.fenx='本月'  "+strGongsID+"\n" + 
				"           group by (dc.id)\n" + 
				"           )tq\n" + 
				"           where dc.id=bq.id(+) and dc.id=tq.id(+)\n" + 
				"           group by rollup(dc.mingc)\n" + 
