...
public class Tielybb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id,lujxxb_id,chezxxb_id,banjh,ches,beiz\n" +
			"from tielybb";
			JDBCcon con = new JDBCcon();
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("lujxxb_id").setWidth(80);
		egu.getColumn("chezxxb_id").setHeader("发站");
		egu.getColumn("chezxxb_id").setWidth(120);
		egu.getColumn("banjh").setHeader("班计划");
		egu.getColumn("banjh").setWidth(120);
		egu.getColumn("ches").setHeader("车数");
		egu.getColumn("ches").setWidth(120);
