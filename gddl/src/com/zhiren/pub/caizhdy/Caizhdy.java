...
public class Caizhdy extends BasePage implements PageValidateListener {
	...
	public void getSelectData() {
		...
		String sql =
			...
			"decode(shifzm,1,'是','否') shifzm,zer\n" + 
...
//		隐藏列
		...
		// /设置显示列名称
		egu.getColumn("bum_id").setHeader("部门");
		egu.getColumn("leibb_id").setHeader("类别");
		egu.getColumn("shifzm").setHeader("是否转码");
		egu.getColumn("zer").setHeader("责任描述");
		// //设置当前列默认值
		...
		shifzm.add(new IDropDownBean("1","是"));
		shifzm.add(new IDropDownBean("0","否"));
