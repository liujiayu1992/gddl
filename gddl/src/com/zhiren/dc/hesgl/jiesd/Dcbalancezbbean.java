...
public class Dcbalancezbbean implements Serializable {
	...
	public String getShulzb_ht() {
		return Shulzb_ht;
	}

	public void setShulzb_ht(String shulzb_ht) {
		Shulzb_ht = shulzb_ht;
	}
