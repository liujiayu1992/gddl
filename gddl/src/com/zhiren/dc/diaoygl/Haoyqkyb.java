...
public class Haoyqkyb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select hy.id,hy.banzh,hy.haoywz,hy.fadyy,hy.gongryy,hy.qityy,hy.haoyrz\n" +
			"from haoyqkyb hy";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("banzh").setHeader("班组");
		egu.getColumn("banzh").setWidth(80);
		egu.getColumn("haoywz").setHeader("上煤位置");
		egu.getColumn("haoywz").setWidth(120);
		egu.getColumn("fadyy").setHeader("发电用油");
		egu.getColumn("fadyy").setWidth(120);
		egu.getColumn("gongryy").setHeader("供热用油");
		egu.getColumn("gongryy").setWidth(120);
		egu.getColumn("qityy").setHeader("其他用油");
		egu.getColumn("qityy").setWidth(120);
		egu.getColumn("haoyrz").setHeader("耗油热值");
		egu.getColumn("haoyrz").setWidth(120);
