...
public class Bucysjhbean implements Serializable {
	...
	public Bucysjhbean(long id, long xuh, long dianchangid, String dianchangmc, long meikdqid, String meikdqmc, long nianf, long yuef, long fazid, String fazmc, long daozid, String daozmc, String pinm, long pic, long pid, String pizjhh, String huanzg, String zhongdg, String zibbcc, long shunh, String tielj) {
		super();
		this.id = id;
		this.xuh = xuh;
		this.dianchangid = dianchangid;
