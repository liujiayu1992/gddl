...
package com.zhiren.common.contrib.palette;
 ...
 * {@link Body} component must wrap the Palette. If JavaScript is not enabled in
 ...
 * <td>yes</td>
 * <td>&nbsp;</td>
 * <td>A List of selected values. Possible selections are defined by the model;
 ...
 * <td>yes</td>
 * <td>&nbsp;</td>
 * <td>Works, as with a {@link org.apache.tapestry.form.PropertySelection}
 * component, to define the possible values. </td>
 * </tr>
 * 
 * <tr>
 * <td>sort</td>
 ...
 * <td>no</td>
 * <td>10</td>
 * <td>The number of rows that should be visible in the Pallete's
 * &lt;select&gt; elements. </td>
 * </tr>
 * 
 * <tr>
 ...
 * <td>The CSS class for the table which surrounds the other elements of the
 * Palette.</td>
 * </tr>
 * 
 * <tr>
 ...
 * <td>no</td>
 * <td>"Selected"</td>
 * <td>If specified, allows a {@link Block} to be placed within the &lt;th&gt;
 ...
 * default, the simple word <code>Selected</code> is used.</td>
 * </tr>
 * 
 * <tr>
 ...
 * <td>no</td>
 * <td>"Available"</td>
 * <td>As with selectedTitleBlock, but for the left column, of items which are
 * available to be selected. The default is the word <code>Available</code>.
 * </td>
 * </tr>
 * 
 * <tr>
 ...
 * <td>no</td>
 * <td>&nbsp;</td>
 * <td>If any of these are specified then they override the default images
 * provided with the component. This allows the look and feel to be customized
 * relatively easily.
 * 
 * <p>
 * The most common reason to replace the images is to deal with backgrounds. The
 * default images are anti-aliased against a white background. If a colored or
...
public abstract class Palette extends BaseComponent implements IFormComponent {
    ...
    /**
     * A set of symbols produced by the Palette script. This is used to provide
     * proper names for some of the HTML elements (&lt;select&gt; and
     * &lt;button&gt; elements, etc.).
     * 
     */
    ...
    protected void renderComponent(IMarkupWriter writer, IRequestCycle cycle) {
        ...
        if (form == null)
            throw new ApplicationRuntimeException(
                    "Palette component must be wrapped by a Form.", this, null,
                    null);
    ...
    private void runScript(IRequestCycle cycle) {
        // Get the script, if not already gotten. Scripts are re-entrant, so it
        // is
        ...
        if (_script == null) {
            ...
            IResourceLocation scriptLocation = getSpecification()
                    .getSpecificationLocation().getRelativeLocation(
                            "Palette.script");
        ...
        if (body == null)
            throw new ApplicationRuntimeException(
                    "Palette component must be wrapped by a Body.", this, null,
                    null);
        ...
        setImage(body, cycle, "deselectDisabledImage",
    ...
    /**
     * Extracts its asset URL, sets it up for preloading, and assigns the
     * preload reference as a script symbol.
     * 
     */
    private void setImage(Body body, IRequestCycle cycle, String symbolName,
            IAsset asset) {
    ...
    /**
     * Constructs a pair of {@link PaletteColumn}s: the available and selected
     * options.
     * 
     */
    private void constructColumns() {
        ...
        PaletteColumn availableColumn = new PaletteColumn((String) _symbols
                .get("availableName"), getRows());
        PaletteColumn selectedColumn = new PaletteColumn(getName(), getRows());

        // Each value specified in the model will go into either the selected or
        // available
        // lists.
        ...
        for (int i = 0; i < count; i++) {
            ...
            PaletteOption o = new PaletteOption(model.getValue(i), model
                    .getLabel(i));
