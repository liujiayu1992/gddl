...
{header:'航次',dataIndex:'HANGC',width:100,editor :new Ext.form.TextField({maxLength:50,width:'auto',selectOnFocus:true}),hidden :false},
{header:'船名',dataIndex:'CHUANM',width:100,editor :new Ext.form.TextField({maxLength:50,width:'auto',selectOnFocus:true}),hidden :false},
{header:'编码',dataIndex:'BIANM',editor :new Ext.form.TextField({maxLength:12,width:80,selectOnFocus:true}),hidden :false},
{header:'销售供应商',dataIndex:'GONGYS',width:100,editor :new Ext.form.TextField({maxLength:50,width:'auto',selectOnFocus:true}),hidden :false},
...
{header:'装船量',dataIndex:'ZHUANGCL',width:60,editor :new Ext.form.NumberField({decimalPrecision:3,selectOnFocus:true}),hidden :false},
{header:'装船时间',dataIndex:'ZHUANGCJSSJ',renderer:function(value){ return (value==null || value=='')?'':('object' != typeof(value)?value:value.dateFormat('Y-m-d'));},width:80,editor :new Ext.form.DateField({allowBlank:true,format:'Y-m-d'}),hidden :false},
...
{name:'ZHUANGCL'},
{name:'ZHUANGCJSSJ'},
{name:'MT'},{name:'MAD'},{name:'AAR'},{name:'AAD'},{name:'AD'},{name:'VAR'},{name:'VAD'},{name:'VDAF'},{name:'FCAD'},{name:'QGRAD'},{name:'QGRD'},{name:'QNET_AR'},{name:'STAD'},{name:'STD'},{name:'QBAD'},{name:'HAR'},{name:'HAD'},{name:'HDAF'},{name:'HUAYSJ'},{name:'HUAYBH'},{name:'HUAYY'},{name:'BEIZ'}])});
...
ds:gridDiv_ds,
width:bodyWidth,
clicksToEdit:1,frame:true,tbar: ['装船时间',jiexrq=new Ext.form.DateField({
	allowBlank:true,
	format:'Y-m-d',
