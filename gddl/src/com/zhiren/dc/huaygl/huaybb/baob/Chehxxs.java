 ...
 * 描述：增加盈吨、亏吨列
 */
public class Chehxxs extends BasePage {
...
//		System.out.println(sql);
		...
		ArrHeader[0]=new String[] {"矿别","发站","发货日期","车皮号","票重","净重","盈吨","亏吨","是否结算"};
		
		int ArrWidth[]=new int[] {120,60,80,80,80,80,80,80,50};
...
//		rt.body.setColFormat(strFormat);
   ...
   private boolean _ReturnChick = false;
	...
	public void beginResponse(IMarkupWriter writer, IRequestCycle cycle) {
		Visit visit = (Visit) getPage().getVisit();
		  ch=cycle.getRequestContext().getParameter("fahb_id");
