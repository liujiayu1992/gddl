...
public class Yunsfsreport extends BasePage {
	/*
	...
	private String getRezc() {
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"名称","拼音","备注"};
		// 列宽
		int ArrWidth[] = new int[] { 100, 100, 120 };

		// 设置页标题
		rt.setTitle("运输方式表", ArrWidth);
