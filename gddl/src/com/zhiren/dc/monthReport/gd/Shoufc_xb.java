...
private boolean _RefurbishChick = false;
	...
	public String getPrintTable() {
		...
		selectSql += 
			"select decode(shoufcyllbb_id,0,'入库煤量',1,'暂估煤量',2,'暂估冲回煤量') as shoufcyllbb_id,\n" +
			"       qickc_shul,\n" + 
			"       qickc_danj,\n" + 
			"       qickc_jine,\n" + 
			"       benyrk_shul,\n" + 
		...
		ArrHeader[0] = new String[]{"名称","期初库存","期初库存","期初库存","本月入库","本月入库","本月入库","本月入库","本月入库","本月耗用","本月耗用","本月耗用","本月耗用","本月耗用","水分差调整量","水分差调整量","盘点亏损","盘点亏损","月末余额库存","月末余额库存","月末余额库存"};
		ArrHeader[1] = new String[]{"名称","数量（吨）","单价","金额","数量（吨）","煤款单价","运费单价","煤款金额","运费金额","数量（吨）","煤款单价","运费单价","煤款金额","运费金额","数量（吨）","金额","数量（吨）","金额","数量（吨）","单价","金额"};
		...
		rt.setTitle(getNianfValue()+"年"+getYuefValue()+"月煤收、发、存报表", ArrWidth);
