...
public class BjzsjyjgReport  extends BasePage implements PageValidateListener{
...
//******************页面初始设置********************//
	public void beginResponse(IMarkupWriter writer, IRequestCycle cycle) {
		...
		if (!visit.getActivePageName().toString().equals(
			...
			String sql="select max(riq) riq  from bjzsjyjgb ";
	...
	private String getSelectData(){
		...
		String sql ="select i.mingc guoj, to_char(s.JIAOYSJ,'yyyy-mm-dd'),JIAOYJG,ZHIS\n" +
		...
		ArrHeader[0]=new String[] {"名称","BJ现货交易时间","价格<br>(元/吨)","指数"};

		int ArrWidth[]=new int[] {100,130,80,50};
		...
		rt.setTitle("澳大利亚BJ指数现货交易价格行情(15天)", ArrWidth);
		rt.setDefaultTitle(1, 9, "单位：元/吨", Table.ALIGN_LEFT);
