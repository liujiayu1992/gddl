...
public class Rulhysh_yc extends BasePage implements PageValidateListener {
	private String CustomSetKey = "Rulhyyjsh";
	private String msg = "";
	...
	public void Save() {
		...
		while (mdrsl.next()) {
			...
			sql.append("shenhzt").append(" = 3 ,shenhryyj='"+visit.getRenymc()+"',shenhsjyj=sysdate  where id =");
	...
	public void Huit() {
		...
		while (mdrsl.next()) {
			...
			sql.append("update ").append(tableName).append(" set ");
			sql.append("shenhzt").append(" = 2 , shenhryyj='',shenhsjyj=null ");
	...
	public void getSelectData() {
		...
		sql=
				...
				"      where r.rulbzb_id=rb.id and r.jizfzb_id=j.id \n" + 
				       IsGul+
				"      and r.shenhzt=1 and r.meil!=0 order by r.rulrq,j.mingc,rb.xuh";
