...
public class Zengkkbean implements Serializable{
	...
	public Zengkkbean(long id, int xuh, String zhibb_id, String tiaojb_id, double shangx, double xiax, String danwb_id, double jis, String jisdwid, double kouj, String koujdw, double zengfj, String zengfjdw, String xiaoscl, double jizzkj, double jizzb, String canzxm, String canzxmdw, double canzsx, double canzxx, String jiesxxb_id, String yunsfsb_id, String beiz) {
		super();
		this.id = id;
		this.xuh = xuh;
		ZHIBB_ID = zhibb_id;
