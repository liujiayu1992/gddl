...
var gridDiv_cm = new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(),{header:'ID',dataIndex:'ID',hidden :true},{header:'编码',dataIndex:'BIANM',editor :new Ext.form.TextField({maxLength:12,width:80,selectOnFocus:true}),hidden :false},
...
{header:'空干基水(Mad)',dataIndex:'MAD',width:100,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :false},
{header:'收到基灰(Aar)',dataIndex:'AAR',width:100,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :false},
{header:'空干基灰(Aad)',dataIndex:'AAD',width:80,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :true},
{header:'AD',dataIndex:'AD',editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :true},
{header:'收到基挥发份(Var)',dataIndex:'VAR',width:150,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :false},
...
{header:'干燥无灰基挥发分(Vdaf)',dataIndex:'VDAF',width:150,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :true},
...
{header:'空干基硫(Stad)',dataIndex:'STAD',width:80,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :true},
{header:'收到基全硫(St,ar)',dataIndex:'STAR',width:100,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :false},
...
{header:'空干基氢(Had)',dataIndex:'HAD',width:100,editor :new Ext.form.NumberField({allowBlank:true,decimalPrecision:3,selectOnFocus:true}),hidden :false},
...
var gridDiv_ds = new Ext.data.Store({proxy : new Ext.zr.data.PagingMemoryProxy(gridDiv_data),pruneModifiedRecords:true,reader: new Ext.data.ArrayReader({}, [{name:'ID'},{name:'BIANM'},{name:'FAHR'},{name:'PINZ'},{name:'CHEC'},{name:'CHES'},{name:'JIEXRQ'},{name:'BIAOZ'},{name:'JINGZ'},{name:'MT'},{name:'MAD'},{name:'AAR'},{name:'AAD'},{name:'AD'},{name:'VAR'},{name:'VAD'},{name:'VDAF'},{name:'FCAD'},{name:'QGRAD'},{name:'QGRD'},{name:'QNET_AR'},{name:'STAR'},{name:'STAD'},{name:'STD'},{name:'QBAD'},{name:'HAR'},{name:'HAD'},{name:'HDAF'},{name:'HUAYSJ'},{name:'HUAYBH'},{name:'HUAYY'},{name:'BEIZ'},{name:'SHENHZT'}])});
var gridDiv_plant = Ext.data.Record.create([{name: 'ID', type:'string'},{name: 'BIANM', type:'string'},{name: 'FAHR', type:'string'},{name: 'PINZ', type:'string'},{name: 'CHEC', type:'string'},{name: 'CHES', type:'float'},{name: 'JIEXRQ', type:'date'},{name: 'BIAOZ', type:'float'},{name: 'JINGZ', type:'float'},{name: 'MT', type:'float'},{name: 'MAD', type:'float'},{name: 'AAR', type:'float'},{name: 'AAD', type:'float'},{name: 'AD', type:'float'},{name: 'VAR', type:'float'},{name: 'VAD', type:'float'},{name: 'VDAF', type:'float'},{name: 'FCAD', type:'float'},{name: 'QGRAD', type:'float'},{name: 'QGRD', type:'float'},{name: 'QNET_AR', type:'float'},{name: 'STAR', type:'float'},{name: 'STAD', type:'float'},{name: 'STD', type:'float'},{name: 'QBAD', type:'float'},{name: 'HAR', type:'float'},{name: 'HAD', type:'float'},{name: 'HDAF', type:'float'},{name: 'HUAYSJ', type:'date'},{name: 'HUAYBH', type:'string'},{name: 'HUAYY', type:'string'},{name: 'BEIZ', type:'string'},{name:'SHENHZT', type:'float'}]);
