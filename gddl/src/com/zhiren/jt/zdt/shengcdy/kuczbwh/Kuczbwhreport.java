...
public class Kuczbwhreport extends BasePage {
	/*
	...
	private String getRezc() {
		...
		// dianhwhjlb");
		sbsql.append("select id,mingc,zuidikc,JINGJCML,XIANFHKC,dongjjjcmsx,dongjjjcmxx,xiajjjcmsx,xiajjjcmxx,chumqcmzb,RIJHM from diancxxb dc" +
				" order by id");
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","名称","最大库存","警戒储煤量","限负荷库存","冬季经济储煤上限","冬季经济储煤下限","夏季经济储煤上限","夏季经济储煤下限","储煤期储煤指标","日均耗煤"};
		// 列宽
		 int ArrWidth[]=new int[] {60,120,70,90,60,60,60,60,60,90,90};
