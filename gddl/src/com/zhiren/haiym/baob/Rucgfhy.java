...
public class Rucgfhy extends BasePage implements PageValidateListener {
	...
	private String getRucmzjyyb() {
		...
		sql.append(
			...
			"       round_new(z.qnet_ar/4.1816*1000,0) qnet_ar,\n" + 
			"       round_new(z.mt,1) mt,\n" + 
		...
		rt.setTitle(v.getDiancqc() +"<br>港方化验", ArrWidth);
