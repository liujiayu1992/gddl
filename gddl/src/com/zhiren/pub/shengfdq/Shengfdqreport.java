...
public class Shengfdqreport extends BasePage {
	...
	private String getRezc() {
		...
		sbsql.append(" quanc, \n");
		sbsql.append(" piny \n");
		sbsql.append("from shengfdqb \n");
		sbsql.append(" order by xuh,quanc \n");
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","简称","全称","拼音"};
		// 列宽
		int ArrWidth[] = new int[] { 60, 100, 100, 100 };

		// 设置页标题
		rt.setTitle("省份地区信息表", ArrWidth);
