...
public class Hetxxbean implements Serializable{
	/**
	 * 
	 */
	...
	public Hetxxbean(long id, long hetgysid, long gongysid, long diancxxb_id, String hetbh, Date shengxsj, Date guoqsj, Date qiandsj, String qianddd,long jihkjb_id, String gongfdwmc, String gongfdwdz, String gongfdh, String gongffddbr, String gongfwtdlr, String gongfdbgh, String gongfkhyh, String gongfzh, String gongfyzbm, String gongfsh, String xufdwmc, String xufdwdz, String xuffddbr, String xufwtdlr, String xufdh, String xufdbgh, String xufkhyh, String xufzh, String xufyzbm, String xufsh, String hetyj) {
		super();
		this.id = id;
		this.hetgysid = hetgysid;
		this.gongysid = gongysid;
