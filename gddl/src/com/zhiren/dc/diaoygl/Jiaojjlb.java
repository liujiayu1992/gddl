...
public class Jiaojjlb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select j.changczc,j.changckc,j.jiaojzc,j.daozc\n" +
			"from jiaojjlb j";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("changczc").setHeader("厂内重车");
		egu.getColumn("changczc").setWidth(80);
		egu.getColumn("changckc").setHeader("厂内空车");
		egu.getColumn("changckc").setWidth(120);
		egu.getColumn("jiaojzc").setHeader("交接站存");
		egu.getColumn("jiaojzc").setWidth(120);
		egu.getColumn("daozc").setHeader("到站存");
		egu.getColumn("daozc").setWidth(120);
