...
window.onresize=function(){
	...
	SelectDataHeight=tablemainHeight - ConditionHeight +15;
	SelectDataWidth=tablemainWidth+10 ;
...
function setNavigatorButton(){
	...
	if (intCurrentPage<=1){
		document.all.item("firstButton").disabled=true;
		document.all.item("previousButton").disabled=true;
	}else{
	...
	if (intCurrentPage==intAllPages){
		document.all.item("nextButton").disabled=true;
		document.all.item("lastButton").disabled=true;
	}else{
