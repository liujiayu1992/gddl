...
public class Kuangfjsbean implements Serializable {

	private long m_id;// 煤款_id

	private long m_diancjsmkb_id;// 电厂结算煤款表_id
	...
	private String m_meikhjdx;	//煤款合计大写
	
	private String m_yunzfhjdx;	//运费合计大写
	...
	public void setMeikhjdx(String m_meikhjdx) {
		this.m_meikhjdx = m_meikhjdx;
	}
	...
	public void setYunzfhjdx(String m_yunzfhjdx) {
		this.m_yunzfhjdx = m_yunzfhjdx;
	}
	...
	public long getDiancjsmkb_id() {
		return m_diancjsmkb_id;
	}

	public void setDiancjsmkb_id(long id) {
		this.m_diancjsmkb_id = id;
	}
	...
	public Kuangfjsbean(long id, long yid, String tianzdw, String jiesbh,
		...
		this.m_id = id;
//		this.m_diancjsmkb_id = diancjsmkb_id;
		this.m_yid = yid;
		if (tianzdw == null) {
			this.m_Tianzdw = "";
		} else {
		...
		this.m_fahksrq = fahksrq;
		this.m_fahjzrq = fahjzrq;
		this.m_kaisysrq = yansksrq;
		this.m_jiezysrq = yansjzrq;
		this.m_kaihyh = kaihyh;
		this.m_pinz = pinz;
		this.m_yuanshr = yuanshr;
		this.m_zhangh = zhangh;
