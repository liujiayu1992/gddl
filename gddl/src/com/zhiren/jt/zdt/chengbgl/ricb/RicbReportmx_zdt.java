...
//		sbsql.append("select danwmc,daohrq,laimsl,cbsl,ljrez as farl,ljrezdk as farl_dk,round_new(decode(ljrez,0,0,((ljmeij+ljyunf+ljzaf)/ljrez)),2) as daoczhj    \n");
		...
		sbsql.append("             group by diancid,dqid,dc.id,daohrq )  wclj,--日成本    \n");
		...
		ArrHeader[0]=new String[] {"单位","到货日期","煤量","成本量","热值","热值","综合价","煤价","运费","杂费","标煤单价(元/吨)","标煤单价(元/吨)"};
		ArrHeader[1]=new String[] {"单位","到货日期","(吨)","(吨)","(MJ/kg)","(Kcal/kg)","(元/吨)","&nbsp;(元/吨)","(元/吨)","&nbsp;(元/吨)","含税","不含税"};
