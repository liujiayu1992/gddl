...
//					update时检查验收编号
					sql=" select bianm from ((select bianm as bianm,id from kuangfjsmkb) union (select bianm as bianm, id from kuangfjsyfb)) where bianm='"+jiesbh+"' and (id<>"+Meikjsb_id+" and id<>"+Yunfjsb_id+")";
				}
	...
	public static boolean checkbh(String jiesbh,long Meikjsb_id,long Yunfjsb_id) {
		...
		try {
			...
			if(!jiesbh.equals("")){
				...
				if(Meikjsb_id==0&&Yunfjsb_id==0){
//					insert时检查结算编号
					sql = " select bianm from ((select bianm from diancjsmkb) union (select bianm from diancjsyfb)) where bianm='"
						+ jiesbh + "'";
				}else{
//					update时检查验收编号
					sql=" select bianm from ((select bianm,id from diancjsmkb) union (select bianm ,id from diancjsyfb)) where bianm='"+jiesbh+"' and (id<>"+Meikjsb_id+" and id<>"+Yunfjsb_id+")";
				}
...
// 	            结算编号前缀
 	            ...
 	            strJiesbhgssx=MainGlobal.getXitxx_item("结算","区域公司拼音缩写",Diancxxb_Id,"DTRL-XS");
...
// 	          strtmp=strJiesbhqz+strJiesbhgssx+strFadqypysx;
				...
				String Sql="select max(jiesbh) as jiesbh from (select bianm as jiesbh from diancjsmkb where diancxxb_id="+Diancxxb_Id
						+ " union select bianm as jiesbh from diancjsyfb where diancxxb_id="+Diancxxb_Id+")"
...
//			盈亏=结算标准-合同标准
	...
	public static StringBuffer InsertDanpcjsmkb(Balances_variable bsv, IPropertySelectionModel ZhibModel){
		...
		if(!bsv.getShul_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.jiessl_zhibb), 
...
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.jiessl_zhibb)+",'"+bsv.getShul_ht()+"',"+bsv.getGongfsl()+","+bsv.getYanssl()+","+bsv.getJiessl()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getQnetar_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Qnetar_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Qnetar_zhibb)+",'"+bsv.getQnetar_ht()+"',"+MainGlobal.Mjkg_to_kcalkg(bsv.getQnetar_kf(), 0)+","+MainGlobal.Mjkg_to_kcalkg(bsv.getQnetar_cf(), 0)
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getAd_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Ad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Ad_zhibb)+",'"+bsv.getAd_ht()+"',"+bsv.getAd_kf()+","+bsv.getAd_cf()+","+bsv.getAd_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getStd_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Std_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Std_zhibb)+",'"+bsv.getStd_ht()+"',"+bsv.getStd_kf()+","+bsv.getStd_cf()+","+bsv.getStd_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getVdaf_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Vdaf_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Vdaf_zhibb)+",'"+bsv.getVdaf_ht()+"',"+bsv.getVdaf_kf()+","+bsv.getVdaf_cf()+","+bsv.getVdaf_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getMt_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Mt_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Mt_zhibb)+",'"+bsv.getMt_ht()+"',"+bsv.getMt_kf()+","+bsv.getMt_cf()+","+bsv.getMt_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getQgrad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Qgrad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Qgrad_zhibb)+",'"+bsv.getQgrad_ht()+"',"+MainGlobal.Mjkg_to_kcalkg(bsv.getQgrad_kf(),0)+","+MainGlobal.Mjkg_to_kcalkg(bsv.getQgrad_cf(), 0)+","+MainGlobal.Mjkg_to_kcalkg(bsv.getQgrad_js(), 0)+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getQbad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Qbad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Qbad_zhibb)+",'"+bsv.getQbad_ht()+"',"+MainGlobal.Mjkg_to_kcalkg(bsv.getQbad_kf(), 0)+","+MainGlobal.Mjkg_to_kcalkg(bsv.getQbad_cf(), 0)
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getHad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Had_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Had_zhibb)+",'"+bsv.getHad_ht()+"',"+bsv.getHad_kf()+","+bsv.getHad_cf()+","+bsv.getHad_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getStad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Stad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Stad_zhibb)+",'"+bsv.getStad_ht()+"',"+bsv.getStad_kf()+","+bsv.getStad_cf()+","+bsv.getStad_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getMad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Mad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Mad_zhibb)+",'"+bsv.getMad_ht()+"',"+bsv.getMad_kf()+","+bsv.getMad_cf()+","+bsv.getMad_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getAar_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Aar_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Aar_zhibb)+",'"+bsv.getAar_ht()+"',"+bsv.getAar_kf()+","+bsv.getAar_cf()+","+bsv.getAar_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getAad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Aad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Aad_zhibb)+",'"+bsv.getAad_ht()+"',"+bsv.getAad_kf()+","+bsv.getAad_cf()+","+bsv.getAad_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getVad_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Vad_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Vad_zhibb)+",'"+bsv.getVad_ht()+"',"+bsv.getVad_kf()+","+bsv.getVad_cf()+","+bsv.getVad_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getT2_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.T2_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.T2_zhibb)+",'"+bsv.getT2_ht()+"',"+bsv.getT2_kf()+","+bsv.getT2_cf()+","+bsv.getT2_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getYunju_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Yunju_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Yunju_zhibb)+",'"+bsv.getYunju_ht()+"',"+bsv.getYunju_kf()+","+bsv.getYunju_cf()+","+bsv.getYunju_js()+",")
...
//				.append(bsv.getJiesslcy()+","+bsv.getShulzjbz()+","+bsv.getJiakhj()+","+bsv.getJiaksk()+","+bsv.getJiashj()+",0,0,1);	\n");
		...
		if(!bsv.getStar_ht().equals("")){
			...
			sb.append(Fayjsdcz.getDanpcjsmxb_InsertSql(bsv.getDiancxxb_id(), bsv.getXuh(), bsv.getMeikjsb_id(), Fayjsdcz.getProperId(ZhibModel, Locale.Star_zhibb), 
...
//			sql.append("insert into danpcjsmxb (id, xuh, jiesdid, zhibb_id, hetbz, gongf, changf, jies, yingk, zhejbz, zhejje, gongfsl, yanssl, jiessl, koud, kous, kouz, ches, jingz, koud_js, yuns, jiesslcy, jiesdj, jiakhj, jiaksk, jiashj, biaomdj, buhsbmdj, leib)	\n");
//			sql.append("	values(		\n");
//			sql.append("getnewid("+bsv.getDiancxxb_id()+"),"+bsv.getXuh()+","+bsv.getMeikjsb_id()+","+Fayjsdcz.getProperId(getZhibModel(), Locale.Yunju_zhibb)+",'"+bsv.getStar_ht()+"',"+bsv.getStar_kf()+","+bsv.getStar_cf()+","+bsv.getStar_js()+",")
...
////							特殊指标数组只能赋值一次
//							bsv.setJieszbtscl_Items(bsv.getJieszbtscl_Items()+Fayjsdcz.getJieszbtscl(Locale.Yunju_zhibb, SelIds));
//						}
//					}
				}
			}
...
//		}
		...
		try {
			...
			bsv.setMeikxxb_Id(Long.parseLong(MainGlobal.getTableCol("fayslb", "Meikxxb_id", "id in ("+SelIds+")")));
			bsv.setFaz_Id(Long.parseLong(MainGlobal.getTableCol("fayslb", "Faz_id", "id in ("+SelIds+")")));
		} catch (NumberFormatException e) {
			// TODO 自动生成 catch 块
			e.printStackTrace();
		} catch (Exception e) {
...
//				"		and cp.id=yfzl.chepb_id(+) ";
		...
		if(Jieszbsftz.equals("否")){
			...
			sql.append(" 		yuns,jingz,koud,kous,kouz,ches,biaoz,yingk,jiessl,(jiessl-jingz) as jieslcy,yunfjssl,chaokdl,yingd,yingd-yingk as kuid from (select "+Fayjsdcz.getJiesszzh(jies_Jieslqzfs, "yuns", jies_Jsslblxs)+" as yuns,"+Fayjsdcz.getJiesszzh(jies_Guohlqzfs,"jingz",jies_Guohlblxsw)+" as jingz,	\n");
...
//			sql.append("       				f.ruccbb_id,f.ditjsbz,f.ditjsb_id,f.laimsl,f.laimzl,f.laimkc															\n");
			...
			sql.append("	 	(select distinct f.id as fahb_id,k.* from fayslb f,kuangfzlb k where f.zhilb_id=k.id "+yunsdw+" and f.id in ("+SelIds+")) kz			\n");
			sql.append("			where f.zhilb_id=z.id and ftmp.fayslb_id=f.id and f.id=kz.fahb_id(+) and f.faz_id=cz.id and f.pinzb_id=pz.id   								\n");
...
//				如果是则取调整后的票重
			...
			sql.append("       			f.tiaozbz,f.yansbhb_id,f.lie_id,f.yuandz_id,f.yuanshdwb_id,f.kuangfzlb_id,f.liucb_id,f.liucztb_id,f.hedbz,f.beiz,			\n");
			sql.append("       			f.ruccbb_id,f.ditjsbz,f.ditjsb_id,f.laimsl,f.laimzl,f.laimkc																\n");
			sql.append(" 			from fayslb f,chepb cp"+contion_table+" where f.id=cp.fahb_id "+contion_where+" and f.lie_id in("+SelIds+")"+yunsdw+" 			\n"); 
			sql.append(" 			group by f.id,f.yuanid,f.diancxxb_id,f.gongysb_id,f.meikxxb_id,f.pinzb_id,f.faz_id,												\n");
			sql.append("       				f.daoz_id,f.jihkjb_id,f.fahrq,f.daohrq,f.hetb_id,f.zhilb_id,f.jiesb_id,f.yunsfsb_id,f.chec,								\n");
			sql.append("       				f.tiaozbz,f.yansbhb_id,f.lie_id,f.yuandz_id,f.yuanshdwb_id,f.kuangfzlb_id,f.liucb_id,f.liucztb_id,f.hedbz,f.beiz,		\n");
			sql.append("       				f.ruccbb_id,f.ditjsbz,f.ditjsb_id,f.laimsl,f.laimzl,f.laimkc															\n");
