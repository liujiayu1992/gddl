 /*
 * 创建日期 2014-02-08
 * 基于Balances.java 版本1.1.1.6为青铝电厂单独检出并修改
 */
...
public class Balances_ql extends BasePage implements PageValidateListener {
	...
	public Balances_variable getBalanceData(String SelIds,long Diancxxb_id,long Jieslx,long Gongysb_id,
				...
				double Shangcjsl,String Yunsdw,Visit visit) throws Exception{
