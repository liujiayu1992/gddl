...
Ext.form.DateTimeField = Ext.extend(Ext.form.TriggerField,  {
     ...
     */
    getValue : function(){
    //alert(Ext.form.DateTimeField.superclass.getValue.call(this));
...
DateTimeField.setValue('5/4/06');

//Pass a date string (custom format):
DateTimeField.format = 'Y-m-d';
DateTimeField.setValue('2006-5-4');
</code></pre>
    ...
    parseDate : function(value){
		...
		varr = value.split(" ");
		if(varr.length > 1){
			v = new Date(Date.parseDate(varr[0],'Y-m-d'));
			timearr = varr[1].split(":");
			v.setHours(timearr[0]);
			v.setMinutes(timearr[1]);
		}else{
