...
public class Meitzjwcqk extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	//删除
		...
		con.getDelete(strSql);
		strSql=
		"insert into meitzjwcqkb(id,riq,chebj,rucbmdj,fadmzbmdj,rucdwrz,rucrlrzc,diancxxb_id)(select id,riq,chebj,rucbmdj,fadmzbmdj,rucdwrz,rucrlrzc,"+ visit.getDiancxxb_id()+"\n" +
		"from meitzjwcqkb\n" + 
		"where to_char(riq,'YYYYMM')='"+CurrZnDate+"' and diancxxb_id=" + visit.getDiancxxb_id()+
		" union\n" + 
		"select 11,sysdate,11,11,11,11,11 ,"+ visit.getDiancxxb_id()+" from dual)";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id,riq,chebj,rucbmdj,fadmzbmdj,rucdwrz,rucrlrzc\n" +
			"from meitzjwcqkb\n" + 
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("chebj").setHeader("车板价");
		egu.getColumn("chebj").setWidth(100);
		egu.getColumn("rucbmdj").setHeader("入厂标煤单价");
		egu.getColumn("rucbmdj").setWidth(100);
		egu.getColumn("fadmzbmdj").setHeader("发电煤折标煤单价");
		egu.getColumn("fadmzbmdj").setWidth(100);
		egu.getColumn("rucdwrz").setHeader("入厂低位热值");
		egu.getColumn("rucdwrz").setWidth(100);
		egu.getColumn("rucrlrzc").setHeader("入厂入炉热值差");
		egu.getColumn("rucrlrzc").setWidth(100);
