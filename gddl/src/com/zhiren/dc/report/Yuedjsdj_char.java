...
public class Yuedjsdj_char  extends BasePage implements PageValidateListener {
	...
	public String getPrintChar(){
		...
		CategoryDataset dataset = cd.getRsDataChart(rstmp, "RIQ","FENX","RUCMJ");//rs记录集构造生成图片需要的数据
...
//		柱子上字的倾斜度。0:水平
		...
		return ct.ChartBar3D(getPage(), dataset,  getYearValue().getValue()+"年入厂天然煤结算单价",  800,  400);
	}
