...
public class Wangjxxreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select xuh,bianm,mingc from chezxxb \n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","网局代码","网局名称"};

		
		//列宽
		 int ArrWidth[]=new int[] {40,80,120};



		//设置页标题
		rt.setTitle("网局表",ArrWidth);
