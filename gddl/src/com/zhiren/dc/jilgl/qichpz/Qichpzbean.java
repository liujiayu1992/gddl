 ...
 * 日期：2016年6月23日
 * 作者：Qiuzw
 * 修改内容：增加姚孟电厂“提煤单号”的字段定义
 * */

/*
 * 时间：2008-06-09
 * 作者：Qiuzw
 * 描述：增加了“扣皮重”、“扣杂”、“是否有票”字段的定义
 * 影响电厂：
 *       神头电厂修改。
 */
...
public class Qichpzbean implements Serializable {
	...
	private double m_biaozpz = 0.0;

	public double getBiaozpz() {
		return m_biaozpz;
	}

	public void setBiaozpz(double biaozpz) {
		this.m_biaozpz = biaozpz;
	}
	...
	public Qichpzbean(long id, boolean selected, String cheph, String pandmc,
			String fahdw, String meikdw, String pinz, String jihkj,
			double fahl, double maoz, double piz, double koud, String meic,
			String meigy, String shouhr, String chengydw, String changb,
			String beiz, double biaozpz) {
		this.m_id = id;
	...
	public Qichpzbean(String shouhr, String meikdqmc, String meikdwmc,
	...
	public Qichpzbean(boolean selected, String shouhr, String meikdqmc,
			String meikdwmc, String ranlpz, String jihkj, String chengydw,
			String meic, String meigy, String changb, String pandmc, double fahl) {
		this.m_selected = selected;
		this.m_shouhr = shouhr;
		this.m_meikdqmc = meikdqmc;
		this.m_meikdwmc = meikdwmc;
	...
	public Qichpzbean(long id, String cheph, String shouhr, int meikdqb_id,
			...
			String chengydw, String meigy, String pandmc, String meic,
			String changb, String beiz) {
		this.youxcs = youxcs;
		this.m_id = id;
		this.m_cheph = cheph;
		this.m_shouhr = shouhr;
