...
Date.parseCodes = {
    ...
    j: function () {
        return Ext.applyIf({s: "(\\d{1,2})"}, Date.parseCodes["d"])
    },
    D: function () {
    ...
    M: function () {
        ...
        return Ext.applyIf({s: "(" + A.join("|") + ")"}, Date.parseCodes["F"])
    },
    m: {g: 1, c: "m = parseInt(results[{0}], 10) - 1;\n", s: "(\\d{2})"},
    n: function () {
        return Ext.applyIf({s: "(\\d{1,2})"}, Date.parseCodes["m"])
    },
    t: {g: 0, c: null, s: "(?:\\d{2})"},
    L: {g: 0, c: null, s: "(?:1|0)"},
    o: function () {
    ...
    u: {g: 1, c: "ms = parseInt(results[{0}], 10);\n", s: "(\\d{3})"},
    O: {
        g: 1,
    ...
    P: function () {
        return Ext.applyIf({s: "([+-]\\d{2}:\\d{2})"}, Date.parseCodes["O"])
    },
    T: {g: 0, c: null, s: "[A-Z]{1,4}"},
    Z: {g: 1, c: "z = results[{0}] * 1;\n" + "z = (-43200 <= z && z <= 50400)? z : null;\n", s: "([+-]?\\d{1,5})"},
    c: function () {
        var E = Date.formatCodeToRegex, C = [];
        var A = [E("Y", 1), E("m", 2), E("d", 3), E("h", 4), E("i", 5), E("s", 6), {c: "if(results[7] == 'Z'){\no = 0;\n}else{\n" + E("P", 7).c + "\n}"}];
...
Date.formatCodeToRegex = function (B, A) {
    ...
    return C || {g: 0, c: null, s: Ext.escapeRe(B)}
};
