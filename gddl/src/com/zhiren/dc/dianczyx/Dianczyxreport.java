...
public class Dianczyxreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select bianm,mingc,lic,beiz from dianczyxb where diancxxb_id = \n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"编码","名称","里程(公里)","备注"};

		
		
		//列宽
		 int ArrWidth[]=new int[]{80,160,80,240};



		//设置页标题
		rt.setTitle("电厂专用线信息表",ArrWidth);
