...
public class Feiymcreport extends BasePage {
	...
	private String getRezc() {
		...
		sbsql.append(" beiz \n");
		sbsql.append("from feiymcb \n");
		ResultSet rs = cn.getResultSet(sbsql.toString());
		Report rt = new Report();

		// 定义表头数据
		 String ArrHeader[][]=new String[1][2];
		 ArrHeader[0]=new String[] {"名称","备注"};
		// 列宽
		int ArrWidth[] = new int[] {  120, 200 };

		// 设置页标题
		rt.setTitle("费用名称信息表", ArrWidth);
