...
public class Yunsfsext extends BasePage implements PageValidateListener {
	private String msg = "";
	...
	public void getSelectData() {
		...
		ResultSetList rsl = con
				.getResultSetList("select * from yunsfsb  order by mingc");
		ExtGridUtil egu = new ExtGridUtil("gridDiv", rsl);
		// egu.setTitle("车站信息");
		egu.setTableName("yunsfsb");
...
//		egu.addToolbarButton(GridButton.ButtonType_Delete, null);
        ...
        "var end = url.indexOf(';');"+
   	    ...
   	    "url = url + '?service=page/' + 'Yunsfsreport&lx=rezc';" +
