...
function dropdown2(_obj1,_obj2){
	...
	_obj2.style.borderTop="#FC0303 1px solid";
	_obj2.style.borderBottom="#FC0303 1px solid";
	_obj2.style.posLeft =_obj1.offsetLeft+100;
...
function colsCount(){
	...
	var jieslx=document.getElementById("JIESLX").value;
    
	if(jieslx<3){
		
		//价格
	    if(eval(document.all.item("HANSDJ").value)>0&&eval(document.all.item("JIESSL").value)>0){
	    ...
	    //数量盈亏
	    if(eval(document.all.item("GONGFSL").value)>0&&eval(document.all.item("JIESSL").value)>0){
	    	document.all.item("YINGK").value=Math.round((eval(document.all.item("JIESSL").value)-eval(document.all.item("GONGFL").value))*100)/100;
	    ...
	    //热量盈亏
	    if((document.all.item("QNETAR_HT").value>0||document.all.item("QNETAR_HT").value.length>4)&&eval(document.all.item("QNETAR_JS").value)>0){
	    	...
	    	if(document.all.item("QNETAR_HT").value.length==4){
		    	...
		    	if(eval(document.all.item("QNETAR_JS").value)<eval(document.all.item("QNETAR_HT").value)){
		    		...
		    		document.all.item("QNETAR_ZJE").value=-Math.round(eval(document.all.item("JIESSL").value)*eval(document.all.item("QNETAR_ZDJ").value)*100)/100;
		    	}else{
	    		...
	    		var hetrlxx=eval(document.all.item("QNETAR_HT").value.substring(0,4));
	    		var hetrlsx=eval(document.all.item("QNETAR_HT").value.substring(5));
	    		
	    		if(eval(document.all.item("QNETAR_JS").value)-hetrlsx>=0){
	    		
	    			document.all.item("QNETAR_YK").value=Math.round(eval(document.all.item("QNETAR_CF").value)-hetrlsx);
	    		}else{
	    		
	    			document.all.item("QNETAR_YK").value=Math.round(eval(document.all.item("QNETAR_CF").value)-hetrlxx);
	    		}
	    ...
	    /*
	    if(eval(document.all.item("HETHFF").value)>0&&eval(document.all.item("JIESHFF").value)>0){
	    	document.all.item("YINGKHFF").value=Math.round((eval(document.all.item("JIESHFF").value)-eval(document.all.item("HETHFF").value))*100)/100;
			if(eval(document.all.item("JIESHFF").value)<eval(document.all.item("HETHFF").value)){
	    ...
	    if(eval(document.all.item("HETHF").value)>0&&eval(document.all.item("JIESHF").value)>0){
	    	document.all.item("YINGKHF").value=Math.round((eval(document.all.item("JIESHF").value)-eval(document.all.item("HETHF").value))*100)/100;
	    ...
	    if(eval(document.all.item("HETSF").value)>0&&eval(document.all.item("JIESSF").value)>0){
	    	document.all.item("YINGKSF").value=Math.round((eval(document.all.item("JIESSF").value)-eval(document.all.item("HETSF").value))*100)/100;
	    ...
	    */
	    //硫盈亏
	    if(eval(document.all.item("STD_HT").value)>0&&eval(document.all.item("STD_JS").value)>0){
	    	document.all.item("STD_YK").value=Math.round((eval(document.all.item("STD_JS").value)-eval(document.all.item("STD_HT").value))*100)/100;
	    	if(document.all.item("STD_YK").value>0){
	    	
	    		document.all.item("STD_ZJE").value=-Math.round(eval(document.all.item("JIESSL").value)*eval(document.all.item("STD_ZDJ").value)*100)/100;
	    	}else{
    ...
    if(eval(document.all.item("TIELYF").value)>0){
	   	document.all.item("YUNZFHJ").value =Math.round((eval(document.all.item("TIELYF").value)+eval(document.all.item("TIELZF").value)+eval(document.all.item("KUANGQYF").value)
	   										+eval(document.all.item("KUANGQZF").value)+eval(document.all.item("BUKYQYZF").value))*100)/100;
	    document.all.item("YUNFSK").value =Math.round((eval(document.all.item("YUNZFHJ").value))*eval(document.all.item("YUNFSL").value)*100)/100;
...
//     FormatInput("JIAKSL",2);
     ...
     FormatInput("TIELZF",2);
     FormatInput("KUANGQYF",2);
     FormatInput("KUANGQZF",2);
...
function clickQux(){
	...
	Ext.get("addbt").setVisible(true);
   	Ext.get("quxbt").setVisible(false);

//	document.all.item("AddButton").style.display="";
//	document.all.item("QuxButton").style.display="none";
}

function tongbshr(_obj){
	
	var i;
	if(Jiesbs.length>0){
		for(i=0;i<Jiesbs.length;i++){
			
			if(_obj.options(_obj.selectedIndex).text==Jiesbs[i][0]){
            	document.all.item("YUANSHR").value=Jiesbs[i][0];
            	document.all.item("XIANSHR").value=Jiesbs[i][0];
            	document.all.item("DIANCJSBS").value=Jiesbs[i][1];
            	break;
			}
		}
	}
