...
public class Kuangfjsxgbean implements Serializable {
	...
	private String m_kuangfjsbh;

	private String m_hetsl;// 合同数量
	...
	public void setKuangfjsbh(String kuangfjsbh) {
		this.m_kuangfjsbh = kuangfjsbh;
	}
	...
	public void setYanslf(double yansl) {
		this.m_yanslf = yansl;
	}
	...
	public Kuangfjsxgbean() {
	}

	public Kuangfjsxgbean(long id, long yid, String tianzdw,
			String jiesbh, String fahdw, String faz, String shoukdw,
			Date fahksrq, Date fahjzrq, Date kaisysrq, Date jiezysrq,
			String kaihyh, String pinz, String yuanshr, String zhangh,
			String hetsl, double gongfsl, long ches, String xianshr,
			String fapbh, String daibcc, String yansbh, String duifdd,
			String fukfs, double shulzjbz, double yanssl, double yingksl,
			double shulzjje, String hetrl, double gongfrl, double yansrl,
			double jiesrl, double yingkrl, double relzjbz, double relzjje,
			String hethff, double gongfhff, double yanshff, double jieshff,
			double yingkhff, double huiffzjbz, double huiffzjje, String hethf,
			double gongfhf, double yanshf, double jieshf, double yingkhf,
			double huifzjbz, double huifzjje, String hetsf, double gongfsf,
			double yanssf, double jiessf, double yingksf, double shuifzjbz,
			double shuifzjje, String hetlf, double yanslf, double jieslf,
			double liuyk, double liubz, double liuzjbz, double liuzjje,
			double jiessl, double buhsdj, double jiakje, double bukyqjk,
			double jiakhj, double jiaksl, double jiaksk, double jiasje,
			double tielyf, double zaf, double bukyqyzf, double jiskc,
			double buhsyf, double yunfsl, double yunfsk, double yunzfhj,
			double hej, String daxhj, String beiz, double danjc,
			String ranlbmjbr, Date ranlbmjbrq, double kuidjf, double jingz,
			Date jiesrq, String fahrq, double huirdzjbz, double huirdzjje,
			double huirdbz, double gongfhrd, double yanshrd, double qitzf,
			String changcwjbr, Date changcwjbrq, Date ruzrq, String jieszxjbr,
			Date jieszxjbrq, String gongsrlbjbr, Date gongsrlbjbrq,
			double hetjg, long jieslx, double relsx, double relxx,
			double liusx, double liuxx, double yuns, String yunsfs,
			String kuangfjsbh, String meikjsdbh) {
