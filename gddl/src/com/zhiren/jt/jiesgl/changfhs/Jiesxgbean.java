...
public class Jiesxgbean implements Serializable {

	private long m_id;//ц╨©Н_id
	
	private long m_yid;//тк╥я_id
...
//	private long m_chezxxb_id;//

//	private long m_meijb_id;//
	
//	private long m_meikxxb_id;
	
//	private long m_fahdwb_id;
	...
	private String m_jiesrq;//

	private Date m_kaisysrq;//

	private Date m_jiezysrq;//
	...
	private double m_gongfl;//

	private double m_yansl;//
	...
	private double m_danjc;
	private String m_meikjsdbh;
//	private double m_diqcj;
//	private double m_guobf;
//	private double m_zhuangxcf;
//	private double m_laimjgdjj;
//	private double m_lusbcdj;
	...
	public double getDanjc(){
	    return m_danjc;
	}
	public void setDanjc(double danjc){
	    this.m_danjc=danjc;
	}
...
//	}
	...
	public Date getKaisysrq() {
		return m_kaisysrq;
	}

	public void setKaisysrq(Date kaisysrq) {
		this.m_kaisysrq = kaisysrq;
	}

	public Date getJiezysrq() {
		return m_jiezysrq;
	}

	public void setJiezysrq(Date jiezysrq) {
		this.m_jiezysrq = jiezysrq;
	}
	...
	public String getGongfrl() {
		return m_gongfrl;
	}

	public void setGongfrl(String gongfrl) {
...
//	
	...
	public void setGongfl(double gongfl) {
		this.m_gongfl = gongfl;
	}

	public double getYansl() {
		return m_yansl;
	}

	public void setYansl(double yansl) {
		this.m_yansl = yansl;
	}
...
//	public double getDiqcj() {
//		return m_diqcj;
//	}
//
//	public void setDiqcj(double diqcj) {
//		this.m_diqcj = diqcj;
//	}
//	
//	public double getGuobf() {
//		return m_guobf;
//	}
//
//	public void setGuobf(double guobf) {
//		this.m_guobf = guobf;
//	}
//
//	public double getZhuangxcf() {
//		return m_zhuangxcf;
//	}
//
//	public void setZhuangxcf(double zhuangxcf) {
//		this.m_zhuangxcf = zhuangxcf;
//	}
//	
//	public double getLaimjgdjj() {
//		return m_laimjgdjj;
//	}
//
//	public void setLaimjgdjj(double laimjgdjj) {
//		this.m_laimjgdjj = laimjgdjj;
//	}
//	
//	public double getLusbcdj() {
//		return m_lusbcdj;
//	}
//
//	public void setLusbcdj(double lusbcdj) {
//		this.m_lusbcdj = lusbcdj;
//	}
	
	public Jiesxgbean() {
	}

	public Jiesxgbean(long id,long yid,String tianzdw,String jiesbh,String fahdw,String faz,String shoukdw,Date fahksrq,Date fahjzrq,Date kaisysrq,Date jiezysrq,String kaihyh,String pinz,String yuanshr
			,String zhangh,double gongfsl,long ches,String xianshr,String fapbh,String daibcc,String yansbh,String duifdd,String fukfs,double shulzjbz,double yanssl,double yingksl,double shulzjje,String gongfrl
			,double yansrl,double yingkrl,double relzjbz,double relzjje,double gongfhff,double yanshff,double yingkhff,double huiffzjbz,double huiffzjje,double gongfhf,double yanshf,double yingkhf,double huifzjbz
			,double huifzjje,double gongfsf,double yanssf,double yingksf,double shuifzjbz,double shuifzjje,double gongfl,double yansl,double liuyk,double liubz,double liuzjbz,double liuzjje,double jiessl,double buhsdj,double jiakje
			,double bukyqjk,double jiakhj,double jiaksl,double jiaksk,double jiasje,double tielyf,double zaf,double bukyqyzf,double jiskc,double buhsyf,double yunfsl,double yunfsk,double yunzfhj,double hej,String meikhjdx,String yunzfhjdx
			,String daxhj,String beiz,double danjc,String ranlbmjbr,Date ranlbmjbrq,double kuidjf,double jingz,String jiesrq,String fahrq,double huirdzjbz,double huirdzjje,double huirdbz,double gongfhrd,double yanshrd,double qitzf
			,String changcwjbr,Date changcwjbrq,Date ruzrq,String jieszxjbr,Date jieszxjbrq,String gongsrlbjbr,Date gongsrlbjbrq,double hetjg,long jieslx,double relsx,double relxx,double liusx,double liuxx,double yuns,String yunsfs) {
...
//		this.m_lusbcdj=lusbcdj;
	...
	public String toString() {
		...
		buffer.append(',');
		buffer.append(m_kaisysrq);
		buffer.append(',');
		buffer.append(m_jiezysrq);
		buffer.append(',');
		...
		buffer.append(',');
		buffer.append(m_gongfl);
		buffer.append(',');
		buffer.append(m_yansl);
		buffer.append(',');
