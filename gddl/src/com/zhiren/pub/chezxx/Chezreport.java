...
public class Chezreport extends BasePage {
	/*
	...
	private String getRezc() {
		...
		sbsql.append(" where c.lujxxb_id = l.id and c.leib='车站'\n");
		...
		ArrHeader[0] = new String[] { "序号", "编码", "简称", "全称", "拼音", "路局", "类别" };
		// 列宽
		int ArrWidth[] = new int[] { 60, 80, 120, 120, 120, 120, 120 };

		// 设置页标题
		rt.setTitle("车站信息表", ArrWidth);
