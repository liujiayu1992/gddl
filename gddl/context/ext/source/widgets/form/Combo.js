...
Ext.form.ComboBox = Ext.extend(Ext.form.TriggerField, {
    ...
    initEvents : function(){
        ...
        if(this.forceSelection){
        	...
        	this.on('blur', this.doNotForce, this);
        }
    },
    ...
    onSelect : function(record, index){
        ...
        if(this.forceSelection){
        	var Selectelement = document.getElementById(this.transform);
        	Selectelement.selectedIndex = this.selectedIndex;
        	this.onchange();
        }else{
	        var r = this.findRecord(this.valueField, record);
	        if(r){
	        	var Selectelement = document.getElementById(this.transform);
	        	Selectelement.selectedIndex = this.selectedIndex;
	        	this.onchange();
