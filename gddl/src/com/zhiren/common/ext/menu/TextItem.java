...
public class TextItem extends MenuItem implements Serializable {
...
//	private String icon;
	...
	public TextItem(String id,String text,String handler) {
		this.id = id;
		this.text = text;
	...
	public TextItem(String id,String text,String handler,String fieldLabel) {
		this.id = id;
		this.text = text;
		this.handler = handler;
		this.minWidth = 75;
