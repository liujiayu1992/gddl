...
public class Tonghcx2 extends BasePage {

	/**
	 * 作者:王总兵
	 * 时间:2009-10-29 11:38:47
	 * 内容:宣威根据桶号查询分样号2
	 */
...
//				1120
				ArrHeader[0]=new String[] {"序号","桶号","采样号","时间"};
				int ArrWidth[]=new int[] {50,80,80,210};
				  strFormat = new String[] { "", "","","" };
				// 数据
				rt.setTitle(visit.getDiancmc()+"桶号查询_(不满足制样)",ArrWidth);
