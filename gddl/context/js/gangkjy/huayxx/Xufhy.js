...
var gridDiv_ds = new Ext.data.Store({proxy : new Ext.zr.data.PagingMemoryProxy(gridDiv_data),pruneModifiedRecords:true,reader: new Ext.data.ArrayReader({}, [{name:'ID'},{name:'FID'},{name:'FAHR'},{name:'MEIKDW'},{name:'PINZ'},{name:'CHEC'},{name:'CHES'},{name:'JIEXRQ'},{name:'BIAOZ'},{name:'MT'},{name:'MAD'},{name:'AAR'},{name:'AAD'},{name:'AD'},{name:'VAR'},{name:'VAD'},{name:'VDAF'},{name:'FCAD'},{name:'QGRAD'},{name:'QNET_AR'},{name:'STAD'},{name:'STD'},{name:'QBAD'},{name:'HAD'},{name:'HDAF'},{name:'HUAYSJ'},{name:'HUAYBH'},{name:'HUAYY'}])});
var gridDiv_plant = Ext.data.Record.create([{name: 'ID', type:'string'},{name: 'FID', type:'string'},{name: 'FAHR', type:'string'},{name: 'MEIKDW', type:'string'},{name: 'PINZ', type:'string'},{name: 'CHEC', type:'string'},{name: 'CHES', type:'float'},{name: 'JIEXRQ', type:'date'},{name: 'BIAOZ', type:'float'},{name: 'MT', type:'float'},{name: 'MAD', type:'float'},{name: 'AAR', type:'float'},{name: 'AAD', type:'float'},{name: 'AD', type:'float'},{name: 'VAR', type:'float'},{name: 'VAD', type:'float'},{name: 'VDAF', type:'float'},{name: 'FCAD', type:'float'},{name: 'QGRAD', type:'float'},{name: 'QNET_AR', type:'float'},{name: 'STAD', type:'float'},{name: 'STD', type:'float'},{name: 'QBAD', type:'float'},{name: 'HAD', type:'float'},{name: 'HDAF', type:'float'},{name: 'HUAYSJ', type:'date'},{name: 'HUAYBH', type:'string'},{name: 'HUAYY', type:'string'}]);
...
var Huayy_e  = new Ext.form.TextField({width:100,height:20});
...
{columnWidth :.25, items:[{html:'空气干燥基(ad)',height:22}, Mad_e, Aad_e, Vad_e, FCad_e, Qgrad_e, {html:'<div align=center valign=center style="width:100"><hr></div>',height:20}, Stad_e,{html:'<hr>',height:21},{html:strdivs + '弹筒热值(MJ/kg)</div>',height:21},{html:strdivs + '空气干燥基氢(Had)</div>',height:21},{html:strdivs + '化验编号</div>',height:21},{html:'',height:21}]},
{columnWidth :.25, items:[{html:'干燥基(d)',height:22},{html:'<div align=center valign=center style="width:100"><hr></div>',height:20}, Ad_e, Vd_e, FCd_e,{html:'<div align=center valign=center style="width:100"><hr></div>',height:21}, {html:'<div align=center valign=center style="width:100"><hr></div>',height:21}, Std_e,{html:'<hr>'}, Qbad_e, Had_e,Huaybh_e,{html:'',height:21}]}],
buttons:[{text:'确认',minwidth:75,handler:function(){EditGrid();}},{text:'取消',minwidth:75,handler:function(){Rpt_window.hide();}}]}); 

var Rpt_window =new Ext.Window({width:550,height:380,closable:false,modal:true,layout:'fit',items:[ValueForm]});
