...
public class Shoumjsdxg extends BasePage {
...
//			
				if(((Dcbalancebean) getEditValues().get(0)).getJieslx()==Locale.liangpjs_feiylbb_id){//两票结算
					...
					BalanceLiuc.tij("kuangfjsmkb", ((Dcbalancebean) getEditValues().get(0)).getId(), ((Visit) getPage().getVisit()).getRenyID(), Liuc_id,"",false);
					BalanceLiuc.tij("kuangfjsyfb", ((Dcbalancebean) getEditValues().get(0)).getYid(), ((Visit) getPage().getVisit()).getRenyID(), Liuc_id,"",false);
	    ...
	    try{
	    	...
	    	if(getEditValues()!= null && !getEditValues().isEmpty()){
	    		...
	    		if(((Dcbalancebean)getEditValues().get(0)).getId()>0){
	    			...
	    			strbf.append(" delete from kuangfjsmkb where id="+((Dcbalancebean)getEditValues().get(0)).getId()+";	\n");
	    		...
	    		if(((Dcbalancebean)getEditValues().get(0)).getYid()>0){
	    			...
	    			strbf.append("delete from kuangfjsyfb where id="+((Dcbalancebean)getEditValues().get(0)).getYid()+";	\n");
