...
public class Caightmxb extends BasePage {
...
//	得到电厂树的值的级别,(jib:1,2,3,) 1是集团,2是分公司,3是电厂
	...
	private String getCaigysb() {
		...
		sbsql.append(
				...
				"decode(grouping(d.mingc)+grouping(j.mingc),2,'"
				+this.getNianfValue().getValue()+"年预算',1,'"+this.getNianfValue().getValue()+"年预算',\n" + 
				...
				" round_new(sum(n.dinghl*10000*n.daocrz)/sum(n.dinghl*10000)*1000,0)rez,\n" + 
				" round_new(sum(n.chukjg*n.dinghl*10000)/sum(n.dinghl*10000),2)jg,\n" + 
				" round_new(sum(n.yunj*n.dinghl*10000)/sum(n.dinghl*10000),2)yunj,\n" + 
				" round_new(sum(n.zaf*n.dinghl*10000)/sum(n.dinghl*10000),2)zaf,\n" + 
				" round_new(sum(n.qitfy*n.dinghl*10000)/sum(n.dinghl*10000),2)qtfy ,\n" + 
				" round_new(sum(n.daoczhjbhs*n.dinghl*10000)/sum(n.dinghl*10000),2)dczhjbhs,\n" + 
				" round_new(sum(n.daoczhjhs*n.dinghl*10000)/sum(n.dinghl*10000),2)dczhjhs,\n" + 
				" round_new(sum(n.buhsbmdj*n.dinghl*10000)/sum(n.dinghl*10000),2)bhsbmdj\n" + 
				" from niancghtb n,diancxxb d, gongysb g,jihkjb j\n" + 
...
//        System.out.println(sbsql.toString());
		...
		rt.setTitle("年采购合同估算（明细）", ArrWidth);
