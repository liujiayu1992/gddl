...
public class Shengfreport extends BasePage {
	...
	private String getRezc() {
		...
		// dianhwhjlb");
		sbsql.append("select  sf.id,sf.xuh as xuh,   \n");
		sbsql.append(" sf.mingc as mingc, \n");
		sbsql.append(" sf.quanc as quanc, \n");
		sbsql.append(" sf.piny as piny, \n");
		sbsql.append(" sq.quanc as shengfdq_id \n");
		sbsql.append("from shengfb sf,shengfdqb sq \n");
		sbsql.append("where sf.shengfdq_id=sq.id(+)  \n");
		sbsql.append(" order by sf.xuh,sf.quanc \n");
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","简称","全称","拼音","省份地区"};
		// 列宽
		int ArrWidth[] = new int[] { 60, 100, 100, 100, 100 };

		// 设置页标题
		rt.setTitle("省份信息表", ArrWidth);
