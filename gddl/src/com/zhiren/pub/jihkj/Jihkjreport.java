...
public class Jihkjreport extends BasePage {
	...
	private String getRezc() {
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","名称","编号","备注"};
		// 列宽
		int ArrWidth[] = new int[] { 60, 120, 90, 200 };

		// 设置页标题
		rt.setTitle("计划口径表", ArrWidth);
