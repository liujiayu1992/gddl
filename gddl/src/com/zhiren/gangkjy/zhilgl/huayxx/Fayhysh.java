...
public class Fayhysh extends BasePage implements PageValidateListener {
	private String msg = "";
...
//		String sql = Shenhcl.Judgment(con, getZhilbids());
		...
		if(getSHhztValue().getValue().equals("未审核")){
			...
			where=" and z.shenhzt=7 and f.xiaosjsb_id=0 \n";
		}
		String sql ="select z.zhilb_id as id, z.caiyb_id,vg.mingc as gongys, m.mingc as meikdw, dc1.mingc as shouhr, c.mingc as faz, p.mingc as pinz,\n" +
		"f.chec, f.meil as shul, z.huaybh, z.huaysj, nvl(z.qnet_ar,0) qnet_ar, nvl(z.star,0) star, nvl(z.aar,0) aar, nvl(z.var,0) as var, nvl(z.ad,0) ad, nvl(z.vdaf,0) vdaf, nvl(z.mt,0) mt,\n" + 
		...
		" from zhillsb z, fayslb f, vwgongys vg, diancxxb dc1, meikxxb m, chezxxb c, pinzb p, diancxxb dc\n" + 
		" where z.zhilb_id=f.zhilb_id\n" + 
		" and f.gongysb_id=vg.id\n" + 
		" and m.id=f.meikxxb_id\n" + 
		" and f.SHR_DIANCXXB_ID=dc1.id \n"+
		" and c.id=f.faz_id\n" + 
		" and p.id=f.pinzb_id\n" + 
		where+
		" and f.diancxxb_id=dc.id "+
		str+ "   and f.fahrq between "
