...
public class Ranlcbfyfx extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	//删除
		...
		strSql=
		"insert into RANLCBFYB(id,riq,should,shoudjj,faddwrlcb,faddwgdcb,yuglr,diancxxb_id)(\n" + 
		"select "+MainGlobal.getNewID(visit.getDiancxxb_id())+",sysdate,1000,20000,20000,0,100,"+visit.getDiancxxb_id()+" from dual\n" + 
		"\n" + 
		")";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id,riq,should,shoudjj,faddwrlcb,faddwgdcb,yuglr\n" +
			"from RANLCBFYB"+
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("should").setHeader("售电量(万千瓦时)");
		egu.getColumn("should").setWidth(120);
		egu.getColumn("shoudjj").setHeader("售电均价(元/千千瓦时)");
		egu.getColumn("shoudjj").setWidth(120);
		egu.getColumn("faddwrlcb").setHeader("发电单位燃料成本(元/千千瓦时)");
		egu.getColumn("faddwrlcb").setWidth(120);
		egu.getColumn("faddwgdcb").setHeader("发电单位固定成本(元/千千瓦时)");
		egu.getColumn("faddwgdcb").setWidth(120);
		egu.getColumn("yuglr").setHeader("预估利润(万元)");
		egu.getColumn("yuglr").setWidth(120);
