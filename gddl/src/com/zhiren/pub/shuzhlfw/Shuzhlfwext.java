...
public class Shuzhlfwext extends BasePage implements PageValidateListener {
	private String msg = "";
	...
	public void getSelectData() {
		...
		ResultSetList rsl = con
				.getResultSetList("select id, diancxxb_id, mingc, xiax, shangx, leib, beiz\n"
						+ "  from shuzhlfwb\n"
						+ " where diancxxb_id = "
		...
		l.add(new IDropDownBean(1, "数量"));
		l.add(new IDropDownBean(2, "质量"));
        ...
        "var end = url.indexOf(';');"+
   	    ...
   	    "url = url + '?service=page/' + 'Shuzhlfwreport&lx=rezc';" +
