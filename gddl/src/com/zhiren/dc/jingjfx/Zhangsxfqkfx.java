...
public class Zhangsxfqkfx extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	//删除
		...
		strSql=
		"insert into ZHANGSXFQKB(id,riq,qicsjkc,gongml,qizys,haoml,fadhy,gongrhy,cuns,feiscym,shuifctz,qimsjkc,qimzmcm,panyk,ranyklv,diancxxb_id)(\n" + 
		"select "+MainGlobal.getNewID(visit.getDiancxxb_id())+",sysdate,1000,20000,20000,0,100,3400,3500,3500,3500,3500,3500,3500,3500,"+visit.getDiancxxb_id()+" from dual\n" + 
		"\n" + 
		")";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id,riq,qicsjkc,gongml,qizys,haoml,fadhy,gongrhy,cuns,feiscym,shuifctz,qimsjkc,qimzmcm,panyk,ranyklv\n" +
			"from ZHANGSXFQKB"+
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("qicsjkc").setHeader("期初实际库存");
		egu.getColumn("qicsjkc").setWidth(80);
		egu.getColumn("gongml").setHeader("供煤量");
		egu.getColumn("gongml").setWidth(80);
		egu.getColumn("qizys").setHeader("期中运损");
		egu.getColumn("qizys").setWidth(80);
		...
		egu.getColumn("cuns").setHeader("储损");
		egu.getColumn("cuns").setWidth(80);
		egu.getColumn("feiscym").setHeader("非生产用煤");
		egu.getColumn("feiscym").setWidth(80);
		egu.getColumn("shuifctz").setHeader("水分差调整");
		egu.getColumn("shuifctz").setWidth(80);
		egu.getColumn("qimsjkc").setHeader("期末实际库存");
		egu.getColumn("qimsjkc").setWidth(80);
		egu.getColumn("qimzmcm").setHeader("期末帐面存煤");
		egu.getColumn("qimzmcm").setWidth(80);
		egu.getColumn("panyk").setHeader("盘盈亏");
		egu.getColumn("panyk").setWidth(80);
		egu.getColumn("ranyklv").setHeader("盘盈亏率");
		egu.getColumn("ranyklv").setWidth(80);
