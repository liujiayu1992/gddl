...
public class Yunzfwcqk extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	//删除
		...
		strSql=
		"insert into YUNZFWCQK(id,riq,hej,tielyf,fazzf,daozzf,changnzf,qiyf,haiyf,diancxxb_id)(\n" + 
		"select "+MainGlobal.getNewID(visit.getDiancxxb_id())+",sysdate,1000,20000,20000,0,100,3400,3500,"+visit.getDiancxxb_id()+" from dual\n" + 
		"\n" + 
		")";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id,riq,hej,tielyf,fazzf,daozzf,changnzf,qiyf,haiyf\n" +
			"from YUNZFWCQK"+
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("hej").setHeader("合计(元/吨)");
		egu.getColumn("hej").setWidth(80);
		egu.getColumn("tielyf").setHeader("铁路运费(元/吨)");
		egu.getColumn("tielyf").setWidth(120);
		egu.getColumn("fazzf").setHeader("发站杂费(元/吨)");
		egu.getColumn("fazzf").setWidth(120);
		egu.getColumn("daozzf").setHeader("到站杂费(元/吨)");
		egu.getColumn("daozzf").setWidth(120);
		egu.getColumn("changnzf").setHeader("厂内杂费(元/吨)");
		egu.getColumn("changnzf").setWidth(120);
		egu.getColumn("qiyf").setHeader("汽运费(元/吨)");
		egu.getColumn("qiyf").setWidth(120);
		egu.getColumn("haiyf").setHeader("海运费(元/吨)");
		egu.getColumn("haiyf").setWidth(120);
