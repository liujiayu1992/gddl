...
public class GuojyjReport  extends BasePage implements PageValidateListener{
...
//******************页面初始设置********************//
	...
	private String getSelectData(){
		...
		String sql = "select to_char(y.riq,'yyyy-mm-dd') as riq,y.beihblt,y.wti,y.dib from guojyj y\n" +
			"where y.riq<="+riq+"\n" + 
			"and y.riq>"+riq2+"\n" + 
			"order by riq";
		...
		strSQL.append(sql);
		 ...
		 ArrHeader[0]=new String[] {"日期","北海布伦特","WTI","迪拜"};
		...
		rt.setTitle("国际原油价格(15天)", ArrWidth);
		rt.setDefaultTitle(1, 2, "单位：美元/桶", Table.ALIGN_LEFT);
