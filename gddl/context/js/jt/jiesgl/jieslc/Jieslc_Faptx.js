...
function colsCount(){
	...
	if(eval(document.getElementById("JIAKJE").value)>0){
		...
		document.all.item("c").value =Math.round((eval(document.all.item("JIASJE").value)-eval(document.all.item("JIAKHJ").value))*100)/100;
...
function check(){
	if(document.all.item("KAIHYH").value==""){
		alert("开户银行为空，请核对！");
		return false;
	}else if(document.all.item("ZHANGH").value==""){
		alert("银行账号为空，请核对！");
		return false;
	}else if(document.all.item("FAPBH").value==""){
		alert("发票编号为空，请核对！");
		return false;
	}else if(document.all.item("JIAKHJ").value==""){
		alert("价款合计为空，请核对！");
		return false;
	}else if(document.all.item("JIAKSK").value==""){
		alert("税款为空，请核对！");
		return false;
	}else if(document.all.item("JIASJE").value==""){
		alert("合计为空，请核对！");
		return false;
	}else if(document.all.item("MEIKHJDX").value==""){
		alert("煤款合计为空，请核对！");
		return false;
	}else if(document.all.item("BUHSYF").value==""){
		alert("不含税运费为空，请核对！");
		return false;
	}else if(document.all.item("YUNFSK").value==""){
		alert("税款为空，请核对！");
		return false;
	}else if(document.all.item("YUNZFHJ").value==""){
		alert("运杂费合计为空，请核对！");
		return false;
	}else if(document.all.item("YUNZFHJDX").value==""){
		alert("运杂费合计大写为空，请核对！");
		return false;
	}else if(document.all.item("HEJ").value==""){
		alert("合计小写为空，请核对！");
		return false;
	}else if(document.all.item("DAXHJ").value==""){
		alert("合计大写为空，请核对！");
		return false;
	}
	else{
