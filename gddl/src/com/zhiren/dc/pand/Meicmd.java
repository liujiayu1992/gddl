...
public class Meicmd extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select ''meicmc,''cedbh,''yangpzl,cedjj\n" + 
			"from Meicmd";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("meicmc").setHeader("煤场名称");
		egu.getColumn("meicmc").setWidth(80);
		egu.getColumn("cedbh").setHeader("测点编号");
		egu.getColumn("cedbh").setWidth(120);
		egu.getColumn("yangpzl").setHeader("样品重量");
		egu.getColumn("yangpzl").setWidth(120);
		egu.getColumn("cedjj").setHeader("测点间距");
		egu.getColumn("cedjj").setWidth(120);
