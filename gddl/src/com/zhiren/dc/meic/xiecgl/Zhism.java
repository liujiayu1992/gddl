...
public class Zhism extends BasePage implements PageValidateListener {
	// 界面用户提示
	private String msg = "";
	...
	public void getSelectData() {
		...
		TextField Caiybh = new TextField();
		Caiybh.setAllowBlank(true);
		Caiybh.setId("caiybh");
		Caiybh.setListeners(
		...
		tb1.addText(new ToolbarText("清车时间:"));
