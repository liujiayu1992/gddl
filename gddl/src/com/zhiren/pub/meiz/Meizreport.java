...
public class Meizreport extends BasePage {
	/*
	...
	private String getRezc() {
		...
		sbsql.append(" bianm, \n");
		sbsql.append(" mingc \n");
		sbsql.append("from meizb \n");
		sbsql.append(" order by xuh,mingc \n");
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","编码","名称"};
		// 列宽
		int ArrWidth[] = new int[] { 60, 80, 120 };

		// 设置页标题
		rt.setTitle("煤种信息表", ArrWidth);
