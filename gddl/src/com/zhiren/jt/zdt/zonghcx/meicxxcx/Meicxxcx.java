 ...
 */
	public class Meicxxcx extends BasePage implements PageValidateListener {
		...
		public void getSelectData() {
			...
			String sql ="select * from (select mc.id,dc.mingc as diancxxb_id,mc.mingc ,mc.mianj,mc.gaod,mc.tij,mc.changd,mc.kuand,mc.kuc,mc.diandml,'<a href=\""+MainGlobal.getHomeContext(this)+"/app?service=page/ImageReport&&id='||mc.id||'&&mk=meicxx\" target=\"_blank\">查看</a>' as chak,\n"
			...
			egu.getColumn("meict").setHeader("图片名称");
