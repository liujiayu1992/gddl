...
public class Feiymc extends BasePage implements PageValidateListener {
	private String msg = "";
	...
	public void getSelectData() {
		...
		ResultSetList rsl = con
				.getResultSetList("select f.id,f.mingc,f.beiz from feiymcb f order by f.mingc");
		ExtGridUtil egu = new ExtGridUtil("gridDiv", rsl);
		egu.setTableName("feiymcb");
...
//		egu.getColumn("beiz").setDefaultValue("使用");
		//egu.getColumn("beiz").setReturnId(true);
        ...
        "var end = url.indexOf(';');"+
   	    ...
   	    "url = url + '?service=page/' + 'Feiymcreport&lx=rezc';" +
