...
public class Dcbalance extends BasePage {
    // List1
    // dropdwon1,2
    private static Logger logger = LogManager.getLogger(Dcbalance.class);
...
//				shoukdw:kaihyh,zhangh
    ...
    private Huirdbean _Huird;
    public Huirdbean getHuird(){
        if(_Huird==null){
            _Huird=new Huirdbean("0","0","0","0","0","0") ;
        }
        return _Huird;
    }
    ...
    public void setHuird(Huirdbean Huird) {
        _Huird = Huird;
    }
    public List getSelectData() {
        ...
        try {
            ...
            double mYunfjsl_mk = 0;        //运费结算数量(jies b)
...
//            logger.info(((Visit) getPage().getVisit()).getString1());
//logger.info("SelIds"+((Visit) getPage().getVisit()).getString1());
//logger.info("Diancxxb_id"+((Visit) getPage().getVisit()).getLong1());
...
//			设置超/亏吨的显示
            ...
            _Jieszbvalues.add(new Dcbalancezbbean(
                    mShulzb_ht, mQnetar_ht, mStd_ht, mAd_ht,
    ...
    public IPropertySelectionModel getIShoukdwModels() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String kaihyh = "";
                String zhangh = "";
                if (rs.getString("kaihyh") != null) {
                    kaihyh = rs.getString("kaihyh");
                }
                if (rs.getString("zhangh") != null) {
