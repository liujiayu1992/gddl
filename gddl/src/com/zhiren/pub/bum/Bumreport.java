...
public class Bumreport extends BasePage {
	/*
	...
	private String getRezc() {
		...
		// dianhwhjlb");
		sbsql.append(" select mingc from bumb   \n");
		ResultSet rs = cn.getResultSet(sbsql.toString());
		Report rt = new Report();

		// 定义表头数据
		 String ArrHeader[][]=new String[1][1];
		 ArrHeader[0]=new String[] {"部门名称"};
		// 列宽
		int ArrWidth[] = new int[] { 120 };

		// 设置页标题
		rt.setTitle("部门信息表", ArrWidth);
		...
		// 页脚
		 ...
		 rt.setDefautlFooter(1,1,"打印日期:"+DateUtil.FormatDate(new Date()),Table.ALIGN_RIGHT);
