...
public class Yunshtshbean implements Serializable {
	/**
	 * 
	 */
	...
	//´úÉó¶¨×´Ì¬µÄ
	public Yunshtshbean(int xuh,long id, String heth, String gongf, String xuf, long hetl, Date qiandrq, String hetzt,String leib,int shendzt,long Hetlcztb_id,long liucb_id) {
		super();
		this.id = id;
		this.heth = heth;
		this.gongf = gongf;
