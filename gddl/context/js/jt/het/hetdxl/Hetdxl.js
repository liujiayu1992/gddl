...
function leixSelect(obj){
	if(obj.options(obj.selectedIndex).value==1||obj.options(obj.selectedIndex).value==2){//分厂分矿分矿分厂
	...
	}else if(obj.options(obj.selectedIndex).value==3){//分厂
		document.getElementById("DanwSelect").style.display=''; 
		document.getElementById("danw").style.display='';
...
body.onload =function(){
	...
	if(document.getElementById("LeixSelect").options(obj.selectedIndex).value==1||document.getElementById("LeixSelect").options(obj.selectedIndex).value==2){//分厂分矿分矿分厂
		document.getElementById("DanwSelect").style.display=''; 
		document.getElementById("danw").style.display=''; 
		document.getElementById("GongysDropDown").style.display=''; 
		document.getElementById("gongys").style.display=''; 	
	}else if(document.getElementById("LeixSelect").options(obj.selectedIndex).value==3){//分厂
		document.getElementById("DanwSelect").style.display=''; 
		document.getElementById("danw").style.display='';
		document.getElementById("GongysDropDown").style.display='none'; 
		document.getElementById("gongys").style.display='none';  
