...
public class JiesdlrBean implements Serializable { 
...
//	private int m_jijlx; // 基价类型
	...
	private String m_Qnetar_ht;		// 合同热量
	public String getQnetar_ht(){return m_Qnetar_ht;}
	public void setQnetar_ht(String value){m_Qnetar_ht = value;}
	
	private double m_Qnetar_kf;		// 供方热量
	public double getQnetar_kf(){return m_Qnetar_kf;}
	public void setQnetar_kf(double value){	m_Qnetar_kf = value;}
	
	private double m_Qnetar_cf;		// 厂方热量
	public double getQnetar_cf(){return m_Qnetar_cf;}
	public void setQnetar_cf(double value){	m_Qnetar_cf = value;}
	
	private double m_Qnetar_js;		// 厂方结算
	public double getQnetar_js(){return m_Qnetar_js;}
	public void setQnetar_js(double value){	m_Qnetar_js = value;}
	
	private double m_Qnetar_yk;		// 厂方盈亏
	public double getQnetar_yk(){return m_Qnetar_yk;}
	public void setQnetar_yk(double value){	m_Qnetar_yk = value;}
	
	private double m_Qnetar_zdj;		// 折单价
	public double getQnetar_zdj(){return m_Qnetar_zdj;}
	public void setQnetar_zdj(double value){m_Qnetar_zdj = value;}
	
	private double m_Qnetar_zje;		// 这金额
	public double getQnetar_zje(){return m_Qnetar_zje;}
	public void setQnetar_zje(double value){m_Qnetar_zje = value;}
	
	private String m_Std_ht;			//合同硫分
	public String getStd_ht(){return m_Std_ht;}
	public void setStd_ht(String value){m_Std_ht = value;}
	
	private double m_Std_kf;			//供方热量
	public double getStd_kf(){return m_Std_kf;}
	public void setStd_kf(double value){m_Std_kf = value;}
	
	private double m_Std_cf;			//厂方热量
	public double getStd_cf(){return m_Std_cf;}
	public void setStd_cf(double value){m_Std_cf = value;}
	
	private double m_Std_js;			//结算热量
	public double getStd_js(){return m_Std_js;}
	public void setStd_js(double value){m_Std_js = value;}
	
	private double m_Std_yk;			// 厂方盈亏
	public double getStd_yk(){return m_Std_yk;}
	public void setStd_yk(double value){m_Std_yk = value;}
	
	private double m_Std_zdj;		// 折单价
	public double getStd_zdj(){return m_Std_zdj;}
	public void setStd_zdj(double value){m_Std_zdj = value;}
	
	private double m_Std_zje;		// 这金额
	public double getStd_zje(){return m_Std_zje;}
	public void setStd_zje(double value){m_Std_zje = value;}
...
//	}
	...
	public JiesdlrBean(long id, long yid, String tianzdw, String jiesbh,
			String fahdw, String meikdw, String faz, 
//			long yunsfsb_id,
			...
			double yingksl, 
//			double yingd, double kuid, 
			double shulzjje,
			double jiessl, 
//			double jiesslcy, 
			double yunfjsl, double buhsdj,
...
//			double yunju, 
			long meikjsb_id, long yunfjsb_id, long jihkjb_id,
//			double fengsjj, double jiajqdj,	int jijlx,
			String Mjtokcalxsclfs,double kuidjfyf_je,double kuidjfzf_je,
			double chaokdl,	String ChaodOrKuid,
			String mQnetar_ht,
			double mQnetar_kf,
			double mQnetar_cf,
			double mQnetar_js,
...
//		this.m_ChaodOrKuid = ChaodOrKuid;
		this.m_Qnetar_ht=mQnetar_ht;		// 合同热量
		this.m_Qnetar_kf=mQnetar_kf;		// 供方热量
		this.m_Qnetar_cf=mQnetar_cf;		// 厂方热量
		this.m_Qnetar_js=mQnetar_js;		// 厂方结算
		this.m_Qnetar_yk=mQnetar_yk;		// 厂方盈亏
		this.m_Qnetar_zdj=mQnetar_zdj;		// 折单价
		this.m_Qnetar_zje=mQnetar_zje;		// 这金额
		
		this.m_Std_ht=mStd_ht;			//合同硫分
		this.m_Std_kf=mStd_kf;			//供方热量
		this.m_Std_cf=mStd_cf;			//厂方热量
		this.m_Std_js=mStd_js;			//结算热量
		this.m_Std_yk=mStd_yk;			// 厂方盈亏
		this.m_Std_zdj=mStd_zdj;		// 折单价
		this.m_Std_zje=mStd_zje;		// 这金额
	}
