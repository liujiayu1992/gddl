package com.zhiren.jt.zdt.yunsjh.yunsjhtb;
...
public class Yunsjhtb extends BasePage implements PageValidateListener {
	...
	public void CoypLastYueData() {
		...
		while (rslcopy.next()) {
			...
			String _id = MainGlobal.getNewID(((Visit) getPage().getVisit())
					.getDiancxxb_id());
			con
					.getInsert("insert into yunsjhtbb(id,riq,diancxxb_id,gongysb_id,faz_id,daoz_id,pinm,yuanc,yuand,beiz,leix) values("
							+
