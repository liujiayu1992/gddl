...
//******************页面初始设置********************//
	...
	private String RT_HET="meikbm_cx";//煤矿编码查询
...
// 直属分厂汇总
				 ...
				 ArrHeader[0]=new String[] {"序号","编码","单位简称","单位全称","省份","所在市区","类别","类型","单位地址"};
			...
			rt.setTitle("煤矿编码查询", ArrWidth);
			rt.setDefaultTitle(1, 4, "单位:"+((Visit) getPage().getVisit()).getDiancmc(), Table.ALIGN_LEFT);
