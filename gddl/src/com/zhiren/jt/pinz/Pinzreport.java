...
public class Pinzreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select xuh,bianm,mingc,piny,decode(zhuangt,1,'使用','停用') as zhuangt,pinzms,leib from pinzb order by xuh,mingc \n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","编码","名称","拼音","状态","品种描述","类别"};

		
		//列宽
		 int ArrWidth[]=new int[] {40,80,120,60,80,200,60};



		//设置页标题
		rt.setTitle("品种信息表",ArrWidth);
