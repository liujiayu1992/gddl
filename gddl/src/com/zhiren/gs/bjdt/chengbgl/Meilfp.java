...
public  class Meilfp extends BasePage implements PageValidateListener {
	private String msg = "";
	...
	public void Save() {
		...
		while(delrsl.next()) {
			...
			sql.append("delete from ").append("caigysmxb").append(" where yushtb_id =").append(delrsl.getString(0)).append(";\n");
		}
...
//			return value==null||"".equals(value)?"null":value;
	...
	public void getSelectData() {
		...
		String chaxun = 
			"select c.id,g.mingc gongysb_id,c.hetl,c.farl,c.jiag,c.beiz from caigysb c,gongysb g\n" +
