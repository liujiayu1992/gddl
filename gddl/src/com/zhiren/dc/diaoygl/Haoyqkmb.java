...
public class Haoyqkmb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		strSql=
			...
			"select hm.id,hm.banz,hm.shangmwz,hm.fadym,hm.gongrym,hm.qitym\n" +
			"from haoyqkmb hm";
			JDBCcon con = new JDBCcon();
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("shangmwz").setHeader("上煤位置");
		egu.getColumn("shangmwz").setWidth(120);
		egu.getColumn("fadym").setHeader("发电用煤");
		egu.getColumn("fadym").setWidth(120);
		egu.getColumn("gongrym").setHeader("供热用煤");
		egu.getColumn("gongrym").setWidth(120);
		egu.getColumn("qitym").setHeader("其他用煤");
		egu.getColumn("qitym").setWidth(120);
