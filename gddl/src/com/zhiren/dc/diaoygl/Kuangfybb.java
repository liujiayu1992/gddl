...
public class Kuangfybb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select id, k.meikxxb_id,k.faz_id,k.ranlpzb_id,k.quebl,k.yujddsj,k.meil,k.chengrc,k.mingrybl\n" +
			"from kuangfybb k";
			JDBCcon con = new JDBCcon();
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("ranlpzb_id").setHeader("品种");
		egu.getColumn("ranlpzb_id").setWidth(120);
		egu.getColumn("quebl").setHeader("昨日实际装车数");
		egu.getColumn("quebl").setWidth(120);
		egu.getColumn("yujddsj").setHeader("预计到达时间");
		egu.getColumn("yujddsj").setWidth(120);
		egu.getColumn("meil").setHeader("煤量");
		egu.getColumn("meil").setWidth(120);
		egu.getColumn("chengrc").setHeader("今日承认车数");
		egu.getColumn("chengrc").setWidth(120);
		egu.getColumn("mingrybl").setHeader("明日预报车数");
		egu.getColumn("mingrybl").setWidth(120);
