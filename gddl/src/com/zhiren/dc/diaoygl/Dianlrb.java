...
public class Dianlrb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select d.id,d.jizh,d.gongdl,d.fadl,d.gongrl,d.fadfhl,d.gongrl,d.cansmz,d.jizzk\n" +
			"from dianlrb d";
			JDBCcon con = new JDBCcon();
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("jizh").setHeader("机组号");
		egu.getColumn("jizh").setWidth(80);
		egu.getColumn("gongdl").setHeader("供电量");
		egu.getColumn("gongdl").setWidth(120);
		egu.getColumn("fadfhl").setHeader("发电量");
		egu.getColumn("fadfhl").setWidth(120);
		egu.getColumn("gongrl").setHeader("供热量");
		egu.getColumn("gongrl").setWidth(120);
		egu.getColumn("cansmz").setHeader("掺烧煤种");
		egu.getColumn("cansmz").setWidth(120);
		egu.getColumn("jizzk").setHeader("机组状况");
		egu.getColumn("jizzk").setWidth(120);
