...
public class Gangk extends BasePage implements PageValidateListener {
	private String msg = "";
...
//		Visit visit = (Visit) getPage().getVisit();
		...
		ResultSetList rsl = con.getResultSetList("select cz.id,\n"
				+ "       cz.xuh,\n" + "       cz.bianm,\n"
				+ "       cz.mingc,\n" 
				+ "       cz.quanc,\n"
				+ "       cz.piny,\n" 
		...
		egu.getColumn("lujxxb_id").setHidden(true);
		egu.getColumn("lujxxb_id").setDefaultValue("2");
		egu.getColumn("leib").setHeader("类别");
		egu.getColumn("leib").setHidden(true);
		egu.getColumn("leib").setDefaultValue("港口");
...
//		egu.getColumn("leib").setDefaultValue("车站");
        ...
        "var end = url.indexOf(';');"+
   	    ...
   	    "url = url + '?service=page/' + 'Gangkreport&lx=gangk';" +
