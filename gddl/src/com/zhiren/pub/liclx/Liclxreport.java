...
public class Liclxreport extends BasePage {
	/*
	...
	private String getRezc() {
		...
		// 定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","名称","拼音","备注"};
		// 列宽
		int ArrWidth[] = new int[] { 60, 100, 100, 120 };

		// 设置页标题
		rt.setTitle("里程类型表", ArrWidth);
