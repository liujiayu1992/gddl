...
public class Dianczyxext extends BasePage implements PageValidateListener {
	private String msg = "";
	...
	public void getSelectData() {
		...
		ResultSetList rsl = con
				.getResultSetList("select dcx.id,dcx.bianm,dc.mingc as diancxxb_id,dcx.mingc,dcx.lic,dcx.beiz\n" +
						" from dianczyxb dcx,diancxxb dc\n" + 
						" where dcx.diancxxb_id = dc.id\n"	+str+" order by dcx.mingc");
		ExtGridUtil egu = new ExtGridUtil("gridDiv", rsl);
		egu.setTableName("dianczyxb");
...
//		egu.getColumn("diancxxb_id").editor = null;
        ...
        "var end = url.indexOf(';');"+
   	    ...
   	    "url = url + '?service=page/' + 'Dianczyxreport&lx=rezc';" +
   	    " window.open(url,'newWin');";
	egu.addToolbarItem("{"+new GridButton("打印","function (){"+str1+"}").getScript()+"}");
