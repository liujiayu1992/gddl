...
public class Caiyzzybm_mx extends BasePage {
	...
	public String getBaseSql(String Caiybh) {
		...
		StringBuffer sbsql = new StringBuffer();
				...
				sbsql.append("select  c.caiybm,z.zhiybm from\n");
				sbsql.append(" (select bianm as caiybm, zhillsb_id\n");
				...
				sbsql.append("  where c.zhillsb_id=z.zhillsb_id\n");
				sbsql.append("  and c.caiybm in ("+Caiybh+")\n");
				sbsql.append("  order by c.caiybm");
	...
	public String getPrintTable() {
		...
		int[] ArrWidth=null;
        	...
        	rs = rsl;
        	 ArrHeader = new String[][] {{"采样编号","制样编号"} };
    
    		 ArrWidth = new int[] {100, 100};
    		rt.setTitle("采样转制样列表", ArrWidth);
