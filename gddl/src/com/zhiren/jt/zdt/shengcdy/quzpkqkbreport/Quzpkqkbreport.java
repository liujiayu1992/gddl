...
//******************************************************************************
	private String getSelectData(){
		...
		if(jib==1){//选择集团的时候按照分公司统计,其它的按照到达类型统计
		 ...
		 ArrHeader[0]=new String[] {"电厂","18点","18点","18点","18点","6点","6点","6点","6点","交接记录","交接记录","交接记录","交接记录","厂停时间","厂停时间"};
		 ArrHeader[1]=new String[] {"电厂","取重","排空","待卸","站存","取重","排空","待卸","站存","厂存空车","厂存重车","交接站存","站存","厂停车数","平均时间"};
			...
			//页脚 
			  ...
			  if(((Visit) getPage().getVisit()).getDiancmc().equals("河北大唐")){
				  ...
				  rt.setDefautlFooter(14,2, "制表:",Table.ALIGN_RIGHT);
						...
						rt.setDefautlFooter(14,2, "制表:"+((Visit) getPage().getVisit()).getDiancmc
