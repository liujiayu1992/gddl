...
public class Fayjswsxg extends BasePage {
...
//	        	if(Shoumjsdcz.checkbh(jiesbh,((Dcbalancebean)getEditValues().get(0)).getId(),((Dcbalancebean)getEditValues().get(0)).getYid())){
	        				sql+="begin \n";
			        		sql+=" update diancjsmkb set shoukdw ='"+((Dcbalancebean)getEditValues().get(0)).getShoukdw()+"', \n" +
							        ...
							        " hansdj = "+((Dcbalancebean)getEditValues().get(0)).getShulzjbz()+",\n" +
							       	" bukmk = "+((Dcbalancebean)getEditValues().get(0)).getBukyqjk()+",\n"+
							        " hansmk = "+((Dcbalancebean)getEditValues().get(0)).getJiasje()+",\n" +
							       	" buhsmk = "+((Dcbalancebean)getEditValues().get(0)).getJiakhj()+",\n"+
							        " shuik = "+((Dcbalancebean)getEditValues().get(0)).getJiaksk()+",\n" +
							       	" shuil = "+((Dcbalancebean)getEditValues().get(0)).getJiaksl()+",\n"+
							        " buhsdj = "+((Dcbalancebean)getEditValues().get(0)).getBuhsdj()+",\n"+
								    " beiz = '"+((Dcbalancebean)getEditValues().get(0)).getBeiz()+"',\n" +
								   	" meikje = "+((Dcbalancebean)getEditValues().get(0)).getJiakje()+
								   	" where id ="+((Dcbalancebean)getEditValues().get(0)).getId()+";\n";
			        		
			        		sql+=" update diancjsyfb set shoukdw = '"+((Dcbalancebean)getEditValues().get(0)).getShoukdw()+"',	\n " +
			        				"kaihyh = '"+((Dcbalancebean)getEditValues().get(0)).getKaihyh()+"',	\n " +
			        				"zhangh = '"+((Dcbalancebean)getEditValues().get(0)).getZhangh()+"',	\n " +
	        						"fapbh = '"+((Dcbalancebean)getEditValues().get(0)).getFapbh()+"',	\n"+
	        						" fukfs = '"+((Dcbalancebean)getEditValues().get(0)).getFukfs()+"',	\n beiz='" +((Dcbalancebean)getEditValues().get(0)).getBeiz()+"',"+
...
//		业务类型限制
    	...
    	try{
    		...
    		sql=
    			...
    			"    where  k.liucztb_id = "+BalanceLiuc.getLastStatus("发运结算")+"\n" + 
    			xiasjs_condition + 
    			"        "+yewlx_condition+" ) \n" + 
    			"\tunion (select distinct k1.bianm\n" + 
    			"      from diancjsyfb k1\n" + 
    			"     where k1.liucztb_id = "+BalanceLiuc.getLastStatus("发运结算")+"\n" + 
