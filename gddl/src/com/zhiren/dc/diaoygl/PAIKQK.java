...
public class PAIKQK extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("paikcs").setHeader("排空车数");
		egu.getColumn("paikcs").setWidth(120);
