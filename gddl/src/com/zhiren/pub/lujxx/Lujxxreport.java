...
public class Lujxxreport extends BasePage {
...
//	***************设置消息框******************//
	...
	private String getSelectData(){
		...
		sbsql.append("select xuh,mingc,bianm,piny,beiz from lujxxb order by xuh,mingc \n");
		...
		//定义表头数据
		 ...
		 ArrHeader[0]=new String[] {"序号","名称","编码","拼音","备注"};

		
		//列宽
		 int ArrWidth[]=new int[] {40,160,80,80,240};



		//设置页标题
		rt.setTitle("路局信息表",ArrWidth);
