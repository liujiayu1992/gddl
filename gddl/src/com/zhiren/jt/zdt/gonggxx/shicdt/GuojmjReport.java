...
public class GuojmjReport  extends BasePage implements PageValidateListener{
...
//******************页面初始设置********************//
	...
	private String getSelectData(){
		...
		String sql =
			"select to_char(m.riq,'yyyy-mm-dd') as riq ,m.jiag from guojmj m where m.riq<="+riq+"\n" +
			"and m.riq>"+riq2+"\n" + 
			"order by riq";
		...
		ArrHeader[0]=new String[] {"日期","价格"};

		int ArrWidth[]=new int[] {200,120};
		...
		rt.setTitle("环球煤炭电子交易平台NEWC Index价格(15天)", ArrWidth);
