...
public class Chehxxz extends BasePage {
	...
	public String getPrintTable() {
		...
		return getChezxxcxreport();
	}

	
	private String getChezxxcxreport() {
		...
		String sql=
			...
			"select m.mingc as kuangb,cz.mingc as chez,to_char(f.fahrq ,'yyyy-mm-dd')as fahrq,\n" +
			"c.cheph as cheph,c.biaoz as biaoz,(c.maoz-c.piz) as jinz,\n" + 
...
//		System.out.println(sql);
		...
		ArrHeader[0]=new String[] {"矿别","发站","发货日期","车皮号","票重","净重","是否结算"};
		
		int ArrWidth[]=new int[] {120,60,80,80,80,100,50};
		

		rt.setTitle("车号信息", ArrWidth);
		...
		rt.setDefaultTitle(5, 3, "查询日期:" + getRiq() + "至" + getAfter(),Table.ALIGN_RIGHT);
...
//		rt.body.setColFormat(strFormat);
   ...
   private boolean _ReturnChick = false;
	...
	public void beginResponse(IMarkupWriter writer, IRequestCycle cycle) {
		Visit visit = (Visit) getPage().getVisit();
		  ch=cycle.getRequestContext().getParameter("id");
