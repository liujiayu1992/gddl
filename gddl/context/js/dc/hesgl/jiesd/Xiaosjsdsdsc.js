...
function Count() {
	if (eval(document.all.item("GONGFL").value) > 0) {
    	document.all.item("GONGFSL").value = val(document.all.item("GONGFL").value);
...
function Count2() {
	...
	document.all.item("YUNZFHJ").value = Math.round((eval(document.all.item("TIELYF").value) + eval(document.all.item("TIELZF").value) + eval(document.all.item("KUANGQYF").value) + eval(document.all.item("KUANGQZF").value)) * 100) / 100;
	document.all.item("JIAKJE").value = Math.round((eval(document.all.item("HANSDJ").value) * eval(document.all.item("JIESSL").value) / (1 + eval(document.all.item("JIAKSL").value)) * 100)) / 100;
...
function colsCount() {
	...
	if (eval(document.getElementById("JIAKJE").value) > 0) {
		...
		if (document.getElementById("SHIFCSDJ").value != "否") {
			var tmp = eval(document.getElementById("MEIKHSDJBLXSW").value);
			var tmpblxsw = "1";
			if (tmp > 0) {
			...
			document.all.item("HANSDJ").value = Math.round(eval(document.all.item("JIASJE").value) / eval(document.all.item("JIESSL").value) * eval(tmpblxsw)) / eval(tmpblxsw);
    ...
    if (eval(document.all.item("TIELYF").value) > 0
		|| eval(document.all.item("KUANGQZF").value > 0)) {
    	
    	if (document.getElementById("SHIFCSDJ").value != "否"
    		&& eval(document.getElementById("JIASJE").value) == 0
    		&& eval(document.getElementById("HANSDJ").value) > 0
    		) {
    		
    		var tmp = eval(document.getElementById("YUNFHSDJBLXSW").value);
			var tmpblxsw = "1";
			if (tmp > 0) {
	    	...
	    	document.getElementById("HANSDJ").value = Math.round(eval(document.all.item("YUNZFHJ").value) / eval(document.all.item("JIESSL").value) * eval(tmpblxsw)) / eval(tmpblxsw);
...
function Createcheck() {
  	...
  	if (JIESLXDropDown.getRawValue() != "请选择" &&
      		JIESBHDropDown.getRawValue() != "请选择" && 
      		HETBHDropDown.getRawValue() != "请选择") {
    	...
    	if (JIESLXDropDown.getRawValue() == "请选择") {
      		...
      		alert("请选择结算类型");
    	} else if (JIESBHDropDown.getRawValue() == "请选择") {

      		alert("请选择结算单");
    	} else if (HETBHDropDown.getRawValue() == "请选择") {
...
function checkJiesbh() {
	...
	if (JIESBHDropDown.getRawValue() != "请选择") {
