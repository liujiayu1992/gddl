package com.zhiren.jt.het.xufdw;
...
public class Xufdw extends BasePage implements PageValidateListener {
...
//	通过
	...
	public void getSelectData() {
		...
		ResultSetList rsl = con
				.getResultSetList("select id,mingc,quanc,bianm,kaihyh,zhangh,shuih,youzbm,diz,weitdlr,faddbr,lianxdh,shifdsf from xufdwb order by mingc");
		ExtGridUtil egu = new ExtGridUtil("gridDiv", rsl);
		
		egu.setTableName("xufdwb");
