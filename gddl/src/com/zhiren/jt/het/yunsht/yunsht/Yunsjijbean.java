...
public class Yunsjijbean implements Serializable{
	/**
	 * 
	 */
...
//	}
	...
	public Yunsjijbean(int xuh,String danw){
		this.xuh=xuh;
		this.yunjia = 0;
	}
	public Yunsjijbean(){
	...
	public Yunsjijbean(int xuh,long id, String meikxxb_id, double yunjia, String yunjdw_id, String zhibb_id, String zhibdw_id, String tiaoj_id,double shangx,double xiax) {
		super();
		this.id = id;
		this.meikxxb_id = meikxxb_id;
		this.yunjia = yunjia;
