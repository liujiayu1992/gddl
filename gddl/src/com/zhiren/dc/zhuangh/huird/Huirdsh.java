...
public class Huirdsh extends BasePage implements PageValidateListener {
	...
	public void getSelectData() {
		...
		String sql = "select id,songyrq,huayrq,bianm,bianxwd,ruanhwd,banqwd,liudwd,huayy from huirdjlb where shenhzt=1";
	...
	public void Save1(String strchange, Visit visit) {
		...
		while (mdrsl.next()) {
			...
			sql.append("2").append(",");
			sql.append(" shenh='").append(visit.getRenymc()).append("'\n");
