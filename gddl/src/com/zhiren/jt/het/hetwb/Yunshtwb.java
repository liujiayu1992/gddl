...
//合同
		...
		buffer.append("select hetys_mb.ID,\n");
		buffer.append("       HETBH,\n" );
		...
		buffer.append("       hetys_mb.ID hetys_mb_id,\n" );
		buffer.append("       '' meikmcs \n" );
		buffer.append("  from hetys_mb\n" );
		buffer.append(" where hetys_mb.ID = "+((Visit) getPage().getVisit()).getLong1());
...
/*//数量
		...
		shulBeans.clear();
		buffer.setLength(0);
		buffer.append(" select aa.hetys_id,aa.id,y1, y2,y3,y4, y5, y6, y7, y8,\n" );
		...
		buffer.append("from(\n" );
		buffer.append("\n" );
		buffer.append("select a.hetys_id,a.id,a.pinzb_id,a.yunsfsb_id,a.faz_id,a.daoz_id,a.diancxxb_id,y1.hetl as y1,y2.hetl as y2,y3.hetl as y3,y4.hetl as y4,y5.hetl as y5,y6.hetl as y6,y7.hetl as y7,y8.hetl as y8,\n" );
		buffer.append("y9.hetl as y9,y10.hetl as y10,y11.hetl as y11,y12.hetl as y12\n" );
		buffer.append("from\n" );
		buffer.append("    (select hetys_id,id,to_char(max(hetslb.riq),'MM')Y,max(hetl)hetl,hetslb.pinzb_id,hetslb.yunsfsb_id,hetslb.faz_id,hetslb.daoz_id,hetslb.diancxxb_id\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where hetys_id="+((Visit) getPage().getVisit()).getLong1()+"\n" );
		buffer.append("    group by hetys_id,id,hetslb.pinzb_id,hetslb.yunsfsb_id,hetslb.faz_id,hetslb.daoz_id,hetslb.diancxxb_id\n" );
		buffer.append("    )a,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,1 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='01'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y1,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,2 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='02'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y2,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,3 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='03'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y3,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,4 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='04'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y4,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,5 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='05'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y5,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,6as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='06'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y6,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,7 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='07'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y7,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,8 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='08'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y8,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,9 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='09'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y9,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,10 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='10'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y10,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,11 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='11'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y11,\n" );
		buffer.append("    ----------\n" );
		buffer.append("    (select hetys_id,id,12 as y,hetl\n" );
		buffer.append("    from hetslb\n" );
		buffer.append("    where to_char(riq,'MM')='12'and hetslb.hetys_id="+((Visit) getPage().getVisit()).getLong1()+")y12\n" );
		buffer.append("\n" );
		buffer.append("------------------------------------\n" );
		buffer.append("where a.hetys_id=y1.hetys_id(+) and a.id=y1.id(+)\n" );
		buffer.append("and a.hetys_id=y2.hetys_id(+) and a.id=y2.id(+)\n" );
		buffer.append("and a.hetys_id=y3.hetys_id(+) and a.id=y3.id(+)\n" );
		buffer.append("and a.hetys_id=y4.hetys_id(+) and a.id=y4.id(+)\n" );
		buffer.append("and a.hetys_id=y5.hetys_id(+) and a.id=y5.id(+)\n" );
		buffer.append("and a.hetys_id=y6.hetys_id(+) and a.id=y6.id(+)\n" );
		buffer.append("and a.hetys_id=y7.hetys_id(+) and a.id=y7.id(+)\n" );
		buffer.append("and a.hetys_id=y8.hetys_id(+) and a.id=y8.id(+)\n" );
		buffer.append("and a.hetys_id=y9.hetys_id(+) and a.id=y9.id(+)\n" );
		buffer.append("and a.hetys_id=y10.hetys_id(+) and a.id=y10.id(+)\n" );
		buffer.append("and a.hetys_id=y11.hetys_id(+) and a.id=y11.id(+)\n" );
		buffer.append("and a.hetys_id=y12.hetys_id(+) and a.id=y12.id(+)\n" );
...
//质量
		...
		buffer.append("where hetzlb.zhibb_id=zhibb.id and hetzlb.tiaojb_id=tiaojb.id and hetzlb.danwb_id=danwb.id and hetzlb.hetys_id="+((Visit) getPage().getVisit()).getLong1());
...
//价格
		...
		while(rs3.next()){
			...
			jibean.setTiaoj_id(rs3.getString("tiaojb_id"));
...
//绑定内容、强行合并进行布局
		...
		rt.setTitle("煤 炭 运 输 合 同 模 板", ArrWidth);
		int iRows=0;
		int iHeadRows=4;
...
/*
*huochaoyuan
*2009-10-22调整出卖人/买受人位置和名头显示
*/		
		rt.body.setCellValue(1, 1, "<font size=2><b>受运人:</b></font>"+bean.getXUFDWMC());
		...
		rt.body.setCellValue(3, 1, "<font size=2><b>承运人:</b></font>"+bean.getGONGFDWMC());
//end		
...
//		rt.body.mergeCell(qittkrow+1, 1, qittkrow+1, 18);
		...
		rt.body.setCellValue(gongxfrow, 1, "<font size=2><b>承运方</b></font>");
		rt.body.mergeCell(gongxfrow, 1, gongxfrow, 8);
		rt.body.setCellValue(gongxfrow, 9, "<font size=2><b>收运方</b></font>");
		...
		rt.body.setCellValue(gongxfrow+10, 2, bean.getGONGFZH());
		rt.body.setCellValue(gongxfrow+10,9, "税号:");
		rt.body.setCellValue(gongxfrow+10, 12, bean.getXUFZH());
...
/*
*huochaoyuan
*2009-10-22修改bug，gongsb中关于运输合同的文字显示公式leix应为"运输合同"
*/			
...
//		int iZhilRows=zhilyqBeans.size();
		...
		rt.body.setCellValue(1, 1, "<font size=2><b>承运人:</b></font>"+bean.getGONGFDWMC());
		rt.body.mergeCell(1, 1, 1, 12);
		rt.body.setCellValue(1, 13,  "<font size=2><b>合同编号:</b></font>"+bean.getHetbh());
		rt.body.mergeCell(1, 13, 1, 18);
		...
		rt.body.setCellValue(3, 1, "<font size=2><b>受运人:</b></font>"+bean.getXUFDWMC());
		rt.body.mergeCell(3, 1, 3, 12);
		rt.body.mergeCell(3, 13, 3, 18);
		rt.body.setCellValue(3, 13, "<font size=2><b>签订地点:</b></font>"+bean.getQianddd());
		rt.body.setRowHeight(3,HANGJJ);
		...
		if(this.isTijsh()){
			...
			if(((Visit) getPage().getVisit()).getList9()==null){
			 ...
			 jiagBeansMB=new ArrayList();
			jiagBeansMB.clear();
			ResultSet rmb1=con.getResultSet(buffer);
			while(rmb1.next()){
				Yunsjijbean jibean=new Yunsjijbean();
				jibean.setMeikxxb_id(rmb1.getString("meikxxb_id"));
				jibean.setZhibb_id(rmb1.getString("zhibb_id"));
				jibean.setZhibdw_id(rmb1.getString("danwb_id"));
				jibean.setTiaoj_id(rmb1.getString("tiaojb_id"));
				jibean.setXiax(rmb1.getDouble("XIAX"));
				jibean.setShangx(rmb1.getDouble("SHANGX"));
				jibean.setYunjia(rmb1.getDouble("yunja"));
				jibean.setYunjdw_id(rmb1.getString("yunjdw_id"));
...
//			格式化条款
			int jijRows1=0;
			 lb=jiagBeansMB.size();
			 jiagtks1=new List[lb];
			String jiagtk1="";
			for(int i=0;i<lb;i++){
				Yunsjijbean jigbean=(Yunsjijbean)jiagBeansMB.get(i);
				bshMB.set("煤矿单位",jigbean.getMeikxxb_id());
				bshMB.set("项目",jigbean.getZhibb_id());
				bshMB.set("项目单位",jigbean.getZhibdw_id());
				bshMB.set("条件",jigbean.getTiaoj_id());
				bshMB.set("下限",jigbean.getXiax());
				bshMB.set("上限",jigbean.getShangx());
				bshMB.set("单位",jigbean.getZhibdw_id());
				bshMB.set("价格",jigbean.getYunjia());
				bshMB.set("价格单位",jigbean.getYunjdw_id());
				bshMB.eval(gongs[1]);
				jiagtk1=bshMB.get("文字").toString();
...
/*
*huochaoyuan
*2009-10-22修改页面显示bug，改"收运方"为"受运方"
*/		
		rt.body.setCellValue(gongxfrow, 9, "<font size=2><b>受运方</b></font>");
		rt.body.mergeCell(gongxfrow, 9, gongxfrow, 18);
		rt.body.setCellAlign(gongxfrow, 9, Table.ALIGN_CENTER);
		rt.body.setCellAlign(gongxfrow, 1, Table.ALIGN_CENTER);
