...
Ext.namespace('Ext.zr.select.Selectcombo');

/**
 * @class Ext.zr.select.Selectcombo
 ...
 * @version 0.3.7
 */
Ext.zr.select.Selectcombo = function(config){
	...
	Ext.zr.select.Selectcombo.superclass.constructor.call(this, config);
}

Ext.extend(Ext.zr.select.Selectcombo, Ext.form.ComboBox, {
	/**
	...
	initComponent:function(){
		...
		Ext.zr.select.Selectcombo.superclass.initComponent.call(this);
		if (this.multiSelect){
		...
		if(this.transform){
			...
			if(!this.lazyRender){
                //this.target = true;
                //this.el = Ext.DomHelper.insertBefore(s, true);
	...
	clearValue:function(){
		this.setValue('');
		Ext.zr.select.Selectcombo.superclass.clearValue.call(this);
		this.valueArray = [];
	...
	reset:function(){
		...
		Ext.zr.select.Selectcombo.superclass.reset.call(this);
	},
	...
	*/
	...
	collapse:function(){
		this.hoverOut();
		Ext.zr.select.Selectcombo.superclass.collapse.call(this);
	},

	expand:function(){
		Ext.zr.select.Selectcombo.superclass.expand.call(this);
	},
	...
	validateValue:function(value){
		if(!Ext.zr.select.Selectcombo.superclass.validateValue.call(this, value)){
			return false;
		}
...
Ext.reg('select', Ext.zr.select.Selectcombo);