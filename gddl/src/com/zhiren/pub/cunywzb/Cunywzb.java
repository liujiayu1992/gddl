package com.zhiren.pub.cunywzb;
...
public class Cunywzb extends BasePage implements PageValidateListener {
	private String msg = "";
	...
	public void getSelectData() {
		...
		ResultSetList rsl = con.getResultSetList("select id,diancxxb_id,mingc,decode(zhuangt,0,'是','否') as zhuangt from cunywzb where diancxxb_id =" + v.getDiancxxb_id());
		ExtGridUtil egu = new ExtGridUtil("gridDiv", rsl);
		egu.setTableName("cunywzb");
...
//		egu.getColumn("zhuangt").setReturnId(true);
        ...
        "var end = url.indexOf(';');"+
   	    ...
   	    "url = url + '?service=page/' + 'Cunywzreport&lx=rezc';" +
