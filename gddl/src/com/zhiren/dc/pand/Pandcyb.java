...
public class Pandcyb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("yough").setHeader("油罐号");
		egu.getColumn("yough").setWidth(80);
		egu.getColumn("yough").setHeader("油量");
		egu.getColumn("yough").setWidth(120);
