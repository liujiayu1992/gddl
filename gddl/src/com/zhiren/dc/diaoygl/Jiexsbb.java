...
public class Jiexsbb extends BasePage implements PageValidateListener {
//	界面用户提示
	private String msg="";
	...
	public void getSelectData() {
		...
		String strSql="";
		strSql=
			"select s.id,s.sheb_id,s.shebzt,to_char(s.jianxkssj,'YYYY-MM-Dd')jianxkssj,to_char(s.jianxjssj,'YYYY-MM-Dd')jianxjssj\n" +
			"from jiexsbb s";
			JDBCcon con = new JDBCcon();
...
//		egu.setHeight("bodyHeight");
		...
		egu.getColumn("sheb_id").setHeader("设备名称");
		egu.getColumn("sheb_id").setWidth(80);
		egu.getColumn("shebzt").setHeader("设备状态");
		egu.getColumn("shebzt").setWidth(120);
		egu.getColumn("jianxkssj").setHeader("检修开始时间");
		egu.getColumn("jianxkssj").setWidth(120);
		egu.getColumn("jianxjssj").setHeader("检修结束时间");
		egu.getColumn("jianxjssj").setWidth(120);
